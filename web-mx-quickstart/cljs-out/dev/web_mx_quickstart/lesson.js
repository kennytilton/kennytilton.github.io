...
var _STAR_parent_STAR__orig_val__28155 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28156 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28156);
...
var _STAR_parent_STAR__orig_val__28157 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28158 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28158);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28157);
...
var _STAR_parent_STAR__orig_val__28159 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28160 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28160);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28159);
...
var _STAR_parent_STAR__orig_val__28161 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28162 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28162);
...
var _STAR_parent_STAR__orig_val__28163 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28164 = me__$2;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28164);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28163);
}})], 0))),null,(1),null)),(2),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28161);
}})], 0))),null,(1),null)),(2),null)),(3),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28155);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28165 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28166 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28166);
...
var _STAR_parent_STAR__orig_val__28167 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28168 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28168);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"The count is now....",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28167);
}})], 0))),(new cljs.core.List(null,tiltontec.web_mx.gen.make_tag("span",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,cljs.core.cst$kw$digi_DASH_readout], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,"42")),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model(prop_c_SHARP___$1);
var _cell__$1 = prop_c_SHARP___$1;
var _prop_name__$1 = tiltontec.cell.base.c_prop(prop_c_SHARP___$1);
...
var _STAR_parent_STAR__orig_val__28169 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28170 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28170);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"42",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28169);
}})], 0))),(new cljs.core.List(null,tiltontec.web_mx.gen.make_svg.cljs$core$IFn$_invoke$arity$4("svg",new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$width,(64),cljs.core.cst$kw$height,(64),cljs.core.cst$kw$cursor,cljs.core.cst$kw$pointer,cljs.core.cst$kw$onclick,(function (){
return alert("Increment Feature Not Yet Implemented");
})], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,cljs.core.list(cljs.core.cst$sym$circle,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$cx,"50%",cljs.core.cst$kw$cy,"50%",cljs.core.cst$kw$r,"40%",cljs.core.cst$kw$stroke,"orange",cljs.core.cst$kw$stroke_DASH_width,(5),cljs.core.cst$kw$fill,cljs.core.cst$kw$transparent], null)),cljs.core.list(cljs.core.cst$sym$text,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$class,cljs.core.cst$kw$heavychar,cljs.core.cst$kw$x,"50%",cljs.core.cst$kw$y,"70%",cljs.core.cst$kw$text_DASH_anchor,cljs.core.cst$kw$middle], null),"+"))),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model(prop_c_SHARP___$1);
...
var _STAR_parent_STAR__orig_val__28171 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28172 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28172);
...
var _STAR_parent_STAR__orig_val__28173 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28174 = me__$2;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28174);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"+",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28173);
}})], 0))),null,(1),null)),(2),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28171);
}})], 0))),null,(1),null)),(2),null)),(3),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28165);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28181 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28182 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28182);
...
var _STAR_parent_STAR__orig_val__28183 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28184 = me__$2;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28184);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28183);
}})], 0)));
} else {
return null;
}
}),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["-","=","+","boom"], null)),null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28181);
}})], 0))),null,(1),null)),(2),null)),(3),null)))));
...
var _STAR_parent_STAR__orig_val__28185 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28186 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28186);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28185);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28188 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28189 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28189);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28188);
}})], 0)));
}));
...
/** @this {Function} */
(web_mx_quickstart.lesson.math_keypad.cljs$lang$applyTo = (function (seq28187){
...
var _STAR_parent_STAR__orig_val__28193 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28194 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28194);
...
var _STAR_parent_STAR__orig_val__28195 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28196 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28196);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"The count is now....",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28195);
}})], 0))),(new cljs.core.List(null,tiltontec.web_mx.gen.make_tag("span",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,cljs.core.cst$kw$digi_DASH_readout], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,"42")),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model(prop_c_SHARP___$1);
var _cell__$1 = prop_c_SHARP___$1;
var _prop_name__$1 = tiltontec.cell.base.c_prop(prop_c_SHARP___$1);
...
var _STAR_parent_STAR__orig_val__28197 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28198 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28198);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"42",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28197);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28193);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28199 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28200 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28200);
...
var _STAR_parent_STAR__orig_val__28201 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28202 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28202);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28201);
...
var _STAR_parent_STAR__orig_val__28203 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28204 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28204);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28203);
}})], 0))),null,(1),null)),(2),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28199);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28205 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28206 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28206);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28205);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28207 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28208 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28208);
...
var _STAR_parent_STAR__orig_val__28209 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28210 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28210);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"The speed is now...",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28209);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speedometer(),null,(1),null)),(2),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28207);
}})], 0)));
});
...
var _STAR_parent_STAR__temp_val__28214 = me;
...
var speedo = (function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
...
var _STAR_parent_STAR__orig_val__28215 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28216 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28216);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28215);
...
var _STAR_parent_STAR__orig_val__28217 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28218 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28218);
...
var _STAR_parent_STAR__orig_val__28219 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28220 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28220);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"+",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28219);
}})], 0))),null,(1),null)),(2),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28217);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28221 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28222 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28222);
...
var _STAR_parent_STAR__orig_val__28223 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28224 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28224);
...
var _STAR_parent_STAR__orig_val__28225 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28226 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28226);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28225);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speedometer_3(),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_plus((function (evt){
return tiltontec.matrix.api.mswap_BANG_((function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28223);
}})], 0)));
});
...
return tiltontec.web_mx.gen.make_tag("span",new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,cljs.core.cst$kw$digi_DASH_readout,cljs.core.cst$kw$onclick,(function (p1__28227_SHARP_){
return tiltontec.matrix.api.mswap_BANG_(tiltontec.web_mx.gen.evt_md(p1__28227_SHARP_),cljs.core.cst$kw$mph,cljs.core.inc);
...
var _STAR_parent_STAR__orig_val__28228 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28229 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28229);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,tiltontec.matrix.api.mget(me,cljs.core.cst$kw$display),null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28228);
}})], 0)));
});
web_mx_quickstart.lesson.watches = (function web_mx_quickstart$lesson$watches(){
return tiltontec.web_mx.gen.make_tag("div",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,cljs.core.cst$kw$intro], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,cljs.core.list(cljs.core.cst$sym$h2,"The speed is now..."),cljs.core.list(cljs.core.cst$sym$speedometer_DASH_4),cljs.core.list(cljs.core.cst$sym$speed_DASH_plus,cljs.core.list(cljs.core.cst$sym$fn,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$evt], null),cljs.core.list(cljs.core.cst$sym$mswap_BANG_,cljs.core.list(cljs.core.cst$sym$fmu,cljs.core.cst$kw$speedometer,cljs.core.list(cljs.core.cst$sym$evt_DASH_md,cljs.core.cst$sym$evt)),cljs.core.cst$kw$mph,cljs.core.cst$sym$inc))))),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP_){
var me = tiltontec.cell.base.c_model(prop_c_SHARP_);
var _cell = prop_c_SHARP_;
var _prop_name = tiltontec.cell.base.c_prop(prop_c_SHARP_);
var _cache = tiltontec.cell.base.c_value(prop_c_SHARP_);
...
var _STAR_parent_STAR__orig_val__28230 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28231 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28231);
...
var _STAR_parent_STAR__orig_val__28232 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28233 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28233);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"The speed is now...",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28232);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speedometer_4(),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_plus((function (evt){
return tiltontec.matrix.api.mswap_BANG_((function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
}),tiltontec.web_mx.gen.evt_md(evt),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$me_QMARK_,false,cljs.core.cst$kw$up_QMARK_,true,cljs.core.cst$kw$inside_QMARK_,false], 0));
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28230);
}})], 0)));
});
...
return tiltontec.web_mx.gen.make_tag("span",new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,cljs.core.cst$kw$digi_DASH_readout,cljs.core.cst$kw$onclick,(function (p1__28234_SHARP_){
return tiltontec.matrix.api.mswap_BANG_(tiltontec.web_mx.gen.evt_md(p1__28234_SHARP_),cljs.core.cst$kw$mph,cljs.core.inc);
})], null),new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$name,cljs.core.cst$kw$speedometer,cljs.core.cst$kw$mph,tiltontec.matrix.api.cI.cljs$core$IFn$_invoke$arity$variadic((42),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$watch,(function (slot,me,new_val,prior_val,cell){
if((new_val > (55))){
...
var _STAR_parent_STAR__orig_val__28235 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28236 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28236);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,tiltontec.matrix.api.mget(me,cljs.core.cst$kw$display),null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28235);
}})], 0)));
});
web_mx_quickstart.lesson.watch_cc = (function web_mx_quickstart$lesson$watch_cc(){
return tiltontec.web_mx.gen.make_tag("div",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,cljs.core.cst$kw$intro], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,cljs.core.list(cljs.core.cst$sym$h2,"The speed limit is 55 mph. Your speed is now..."),cljs.core.list(cljs.core.cst$sym$speed_DASH_governor),cljs.core.list(cljs.core.cst$sym$speed_DASH_plus,cljs.core.list(cljs.core.cst$sym$fn,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$evt], null),cljs.core.list(cljs.core.cst$sym$mswap_BANG_,cljs.core.list(cljs.core.cst$sym$fmu,cljs.core.cst$kw$speedometer,cljs.core.list(cljs.core.cst$sym$evt_DASH_md,cljs.core.cst$sym$evt)),cljs.core.cst$kw$mph,cljs.core.cst$sym$inc))))),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP_){
var me = tiltontec.cell.base.c_model(prop_c_SHARP_);
var _cell = prop_c_SHARP_;
var _prop_name = tiltontec.cell.base.c_prop(prop_c_SHARP_);
var _cache = tiltontec.cell.base.c_value(prop_c_SHARP_);
...
var _STAR_parent_STAR__orig_val__28237 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28238 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28238);
...
var _STAR_parent_STAR__orig_val__28239 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28240 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28240);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,"The speed limit is 55 mph. Your speed is now...",null,(1),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28239);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_governor(),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_plus((function (evt){
return tiltontec.matrix.api.mswap_BANG_((function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
}),tiltontec.web_mx.gen.evt_md(evt),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$me_QMARK_,false,cljs.core.cst$kw$up_QMARK_,true,cljs.core.cst$kw$inside_QMARK_,false], 0));
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28237);
}})], 0)));
});
...
var _STAR_parent_STAR__orig_val__28242 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28243 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28243);
...
var _STAR_parent_STAR__orig_val__28244 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28245 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28245);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28244);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_plus((function (p1__28241_SHARP_){
return tiltontec.matrix.api.mset_BANG_((function (){var name__27881__auto__ = cljs.core.cst$kw$cat_DASH_fact;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
}),tiltontec.web_mx.gen.evt_md(p1__28241_SHARP_),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$me_QMARK_,false,cljs.core.cst$kw$up_QMARK_,true,cljs.core.cst$kw$inside_QMARK_,false], 0));
...
var f__23387__auto__ = (function (){var switch__23195__auto__ = (function (state_28251){
var state_val_28252 = (state_28251[(1)]);
if((state_val_28252 === (1))){
var state_28251__$1 = state_28251;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_28251__$1,(2),response_chan);
} else {
if((state_val_28252 === (2))){
var inst_28247 = (state_28251[(2)]);
var inst_28248 = (function (){var response = inst_28247;
return (function (opcode,defer_info){
return tiltontec.matrix.api.mset_BANG_(me__$1,cljs.core.cst$kw$cat_DASH_response,response);
});
})();
var inst_28249 = tiltontec.cell.integrity.call_with_integrity(cljs.core.cst$kw$change,cljs.core.cst$kw$set_DASH_cat,inst_28248);
var state_28251__$1 = state_28251;
...
return (function() {
var web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__ = null;
var web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____0 = (function (){
var statearr_28253 = [null,null,null,null,null,null,null];
(statearr_28253[(0)] = web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__);

(statearr_28253[(1)] = (1));

return statearr_28253;
});
var web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____1 = (function (state_28251){
while(true){
var ret_value__23197__auto__ = (function (){try{while(true){
var result__23198__auto__ = switch__23195__auto__(state_28251);
...
var ex__23199__auto__ = e28254;
var statearr_28255_28261 = state_28251;
(statearr_28255_28261[(5)] = ex__23199__auto__);
...
var G__28262 = state_28251;
state_28251 = G__28262;
continue;
} else {
...
web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__ = function(state_28251){
switch(arguments.length){
case 0:
return web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____0.call(this);
case 1:
return web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____1.call(this,state_28251);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__.cljs$core$IFn$_invoke$arity$0 = web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____0;
web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__.cljs$core$IFn$_invoke$arity$1 = web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto____1;
return web_mx_quickstart$lesson$async_cat_$_state_machine__23196__auto__;
})()
})();
var state__23388__auto__ = (function (){var statearr_28256 = (f__23387__auto__.cljs$core$IFn$_invoke$arity$0 ? f__23387__auto__.cljs$core$IFn$_invoke$arity$0() : f__23387__auto__.call(null));
(statearr_28256[(6)] = c__23386__auto__);
...
var _STAR_parent_STAR__orig_val__28257 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28258 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28258);
...
var _STAR_parent_STAR__orig_val__28259 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28260 = me__$2;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28260);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28259);
}})], 0)));
} else {
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28257);
}})], 0))),null,(1),null)),(2),null)),(3),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28242);
}})], 0)));
});
...
return cleanup(prior);
}),cljs.core.cst$kw$on_DASH_quiesce,(function (c){
return cleanup(tiltontec.matrix.api.c_value(c));
...
var _STAR_parent_STAR__orig_val__28263 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28264 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28264);
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28263);
}})], 0)));
});
web_mx_quickstart.lesson.in_review = (function web_mx_quickstart$lesson$in_review(){
return tiltontec.web_mx.gen.make_tag("div",new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,cljs.core.cst$kw$intro], null),cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$code,cljs.core.list(cljs.core.list(cljs.core.cst$sym$clojure$core_SLASH_assert,cljs.core.cst$sym$me,"no me for cFkids"),cljs.core.list(cljs.core.cst$sym$tiltontec$model$core_SLASH_the_DASH_kids,cljs.core.list(cljs.core.cst$sym$h2,cljs.core.list(cljs.core.cst$sym$let,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$excess,cljs.core.list(cljs.core.cst$sym$_DASH_,cljs.core.list(cljs.core.cst$sym$mget,cljs.core.list(cljs.core.cst$sym$fmu,cljs.core.cst$kw$speedometer),cljs.core.cst$kw$mph),(55))], null),cljs.core.list(cljs.core.cst$sym$pp_SLASH_cl_DASH_format,null,"The speed is ~8,1f mph ~:[over~;under~] the speed limit.",cljs.core.list(cljs.core.cst$sym$Math_SLASH_abs,cljs.core.cst$sym$excess),cljs.core.list(cljs.core.cst$sym$neg_QMARK_,cljs.core.cst$sym$excess)))),cljs.core.list(cljs.core.cst$sym$speedo_DASH_review),cljs.core.list(cljs.core.cst$sym$speed_DASH_plus,cljs.core.list(cljs.core.cst$sym$fn_STAR_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$p1__28265_SHARP_], null),cljs.core.list(cljs.core.cst$sym$mswap_BANG_,cljs.core.list(cljs.core.cst$sym$fmu,cljs.core.cst$kw$speedometer,cljs.core.list(cljs.core.cst$sym$evt_DASH_md,cljs.core.cst$sym$p1__28265_SHARP_)),cljs.core.cst$kw$mph,cljs.core.cst$sym$inc))))),cljs.core.cst$kw$value,tiltontec.cell.base.unbound,cljs.core.cst$kw$rule,(function (prop_c_SHARP_){
var me = tiltontec.cell.base.c_model(prop_c_SHARP_);
var _cell = prop_c_SHARP_;
var _prop_name = tiltontec.cell.base.c_prop(prop_c_SHARP_);
var _cache = tiltontec.cell.base.c_value(prop_c_SHARP_);
...
var _STAR_parent_STAR__orig_val__28266 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28267 = me;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28267);
...
var _STAR_parent_STAR__orig_val__28268 = tiltontec.model.core._STAR_parent_STAR_;
var _STAR_parent_STAR__temp_val__28269 = me__$1;
(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__temp_val__28269);
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten((new cljs.core.List(null,(function (){var excess = (tiltontec.matrix.api.mget((function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
}),me__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$me_QMARK_,false,cljs.core.cst$kw$up_QMARK_,true,cljs.core.cst$kw$inside_QMARK_,false], 0));
...
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28268);
}})], 0))),(new cljs.core.List(null,web_mx_quickstart.lesson.speedo_review(),(new cljs.core.List(null,web_mx_quickstart.lesson.speed_plus((function (p1__28265_SHARP_){
return tiltontec.matrix.api.mswap_BANG_((function (){var name__27881__auto__ = cljs.core.cst$kw$speedometer;
return tiltontec.model.core.fm_navig.cljs$core$IFn$_invoke$arity$variadic((function (p1__27880__27882__auto__){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name__27881__auto__,tiltontec.model.core.mget_QMARK_(p1__27880__27882__auto__,cljs.core.cst$kw$name));
}),tiltontec.web_mx.gen.evt_md(p1__28265_SHARP_),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$me_QMARK_,false,cljs.core.cst$kw$up_QMARK_,true,cljs.core.cst$kw$inside_QMARK_,false], 0));
})(),cljs.core.cst$kw$mph,cljs.core.inc);
})),null,(1),null)),(2),null)),(3),null)))));
}finally {(tiltontec.model.core._STAR_parent_STAR_ = _STAR_parent_STAR__orig_val__28266);
}})], 0)));
});
web_mx_quickstart.lesson.ex_in_review = new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$menu,"Review",cljs.core.cst$kw$title,"Review",cljs.core.cst$kw$route,cljs.core.cst$kw$in_DASH_review,cljs.core.cst$kw$builder,web_mx_quickstart.lesson.in_review,cljs.core.cst$kw$preamble,"Our closing example reprises all the key Web/MX features.",cljs.core.cst$kw$code,"(defn speedo-review []\n  (span {:class :digi-readout\n         :style (cF {:color (if (> (mget me :mph) 55)\n                              \"red\" \"cyan\")})}\n    {:name     :speedometer\n     :mph      (cI 42)\n     :air-drag (let [xi (atom nil)\n                     cleanup (fn [i]\n                               (when (number? i)\n                                 (js/clearInterval i)))]\n                 (cF+ [:watch (fn [_ _ new prior _]\n                                (cleanup prior))\n                       :on-quiesce (fn [c]\n                                     (cleanup (c-value c)))]\n                   (js/setInterval\n                     #(mswap! me :mph * 0.98) 1000)))}\n    (pp/cl-format nil \"~8,1f mph\" (mget me :mph))))\n\n(defn in-review []\n  (div {:class :intro}\n    (h2 (let [excess (- (mget (fmu :speedometer) :mph) 55)]\n          (pp/cl-format nil \"The speed is ~8,1f mph ~:[over~;under~] the speed limit.\"\n            (Math/abs excess) (neg? excess))))\n    (speedo-review)\n    (speed-plus #(mswap! (fmu :speedometer (evt-md %)) :mph inc))))",cljs.core.cst$kw$comment,"\n   <ul type=circle>\n   <li>it looks and works like standard HTML, SVG, CSS, and CLJS;</li>\n   <li>all state dependencies are property to property;</li>\n   <li>the <code>H2</code> computes its text by navigating to the speedometer widget to read the <code>mph</code> value;</li>\n   <li>the <code>(speed-plus ...)</code> button navigates to the speedometer to mutate <code>mph</code> value;</li>\n   <li>the <code>air-drag</code> async interval mutates the DAG, reducing the <code>mph</code>;</li>\n   <li>function <code>speed-plus</code> demonstrates reusable composition.</li>\n   </ul>"], null);
