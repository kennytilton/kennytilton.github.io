...
var c_30739 = (new goog.debug.Console());
var G__30738_30740 = c_30739.getFormatter();
goog.object.set(G__30738_30740,"showAbsoluteTime",false);

goog.object.set(G__30738_30740,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_30739);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__30741_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__30741_SHARP_);
