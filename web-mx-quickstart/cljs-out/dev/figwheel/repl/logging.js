...
var c_31173 = (new goog.debug.Console());
var G__31172_31174 = c_31173.getFormatter();
goog.object.set(G__31172_31174,"showAbsoluteTime",false);

goog.object.set(G__31172_31174,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_31173);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__31175_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__31175_SHARP_);
