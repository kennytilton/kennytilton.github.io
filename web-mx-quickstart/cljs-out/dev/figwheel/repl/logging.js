...
var c_30665 = (new goog.debug.Console());
var G__30664_30666 = c_30665.getFormatter();
goog.object.set(G__30664_30666,"showAbsoluteTime",false);

goog.object.set(G__30664_30666,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_30665);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__30667_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__30667_SHARP_);
