...
var c_58063 = (new goog.debug.Console());
var G__58062_58064 = c_58063.getFormatter();
goog.object.set(G__58062_58064,"showAbsoluteTime",false);

goog.object.set(G__58062_58064,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_58063);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__58065_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__58065_SHARP_);
