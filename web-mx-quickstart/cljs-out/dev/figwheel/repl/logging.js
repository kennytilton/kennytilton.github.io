...
var c_25051 = (new goog.debug.Console());
var G__25050_25052 = c_25051.getFormatter();
goog.object.set(G__25050_25052,"showAbsoluteTime",false);

goog.object.set(G__25050_25052,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_25051);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__25053_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__25053_SHARP_);
