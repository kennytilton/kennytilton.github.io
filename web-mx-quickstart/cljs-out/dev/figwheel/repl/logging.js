...
var c_24991 = (new goog.debug.Console());
var G__24990_24992 = c_24991.getFormatter();
goog.object.set(G__24990_24992,"showAbsoluteTime",false);

goog.object.set(G__24990_24992,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_24991);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__24993_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__24993_SHARP_);
