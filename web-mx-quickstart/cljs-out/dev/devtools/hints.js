...
}catch (e32033){var _e = e32033;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___32036 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___32036)){
var seen_errors_32037 = temp__5802__auto___32036;
if(cljs.core.truth_(seen_errors_32037.has(self))){
} else {
seen_errors_32037.add(self);

var temp__5804__auto___32038 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___32038)){
var sense_32039 = temp__5804__auto___32038;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32039)].join(''));
} else {
}
}
} else {
