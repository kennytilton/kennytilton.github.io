...
}catch (e32042){var _e = e32042;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___32045 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___32045)){
var seen_errors_32046 = temp__5802__auto___32045;
if(cljs.core.truth_(seen_errors_32046.has(self))){
} else {
seen_errors_32046.add(self);

var temp__5804__auto___32047 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___32047)){
var sense_32048 = temp__5804__auto___32047;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32048)].join(''));
} else {
}
}
} else {
