...
var map__77168 = top_item;
var map__77168__$1 = (((((!((map__77168 == null))))?(((((map__77168.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77168.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__77168):map__77168);
var file = cljs.core.get.call(null,map__77168__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__77168__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__77168__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e77167){var _e = e77167;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___77170 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___77170)){
var seen_errors_77171 = temp__5802__auto___77170;
if(cljs.core.truth_(seen_errors_77171.has(self))){
} else {
seen_errors_77171.add(self);

var temp__5804__auto___77172 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___77172)){
var sense_77173 = temp__5804__auto___77172;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_77173)].join(''));
} else {
}
}
} else {
