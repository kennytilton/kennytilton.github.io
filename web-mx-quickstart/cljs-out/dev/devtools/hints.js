...
}catch (e32037){var _e = e32037;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___32040 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___32040)){
var seen_errors_32041 = temp__5802__auto___32040;
if(cljs.core.truth_(seen_errors_32041.has(self))){
} else {
seen_errors_32041.add(self);

var temp__5804__auto___32042 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___32042)){
var sense_32043 = temp__5804__auto___32042;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32043)].join(''));
} else {
}
}
} else {
