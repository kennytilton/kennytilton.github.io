...
}catch (e32028){var _e = e32028;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___32031 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___32031)){
var seen_errors_32032 = temp__5802__auto___32031;
if(cljs.core.truth_(seen_errors_32032.has(self))){
} else {
seen_errors_32032.add(self);

var temp__5804__auto___32033 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___32033)){
var sense_32034 = temp__5804__auto___32033;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32034)].join(''));
} else {
}
}
} else {
