...
var file = cljs.core.get.call(null,map__38710__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38710__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38710__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e38709){var _e = e38709;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___38712 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___38712)){
var seen_errors_38713 = temp__5802__auto___38712;
if(cljs.core.truth_(seen_errors_38713.has(self))){
} else {
seen_errors_38713.add(self);

var temp__5804__auto___38714 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___38714)){
var sense_38715 = temp__5804__auto___38714;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_38715)].join(''));
} else {
}
}
} else {
