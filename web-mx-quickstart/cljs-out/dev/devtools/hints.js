...
var file = cljs.core.get.call(null,map__31964__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__31964__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__31964__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e31963){var _e = e31963;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___31966 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___31966)){
var seen_errors_31967 = temp__5802__auto___31966;
if(cljs.core.truth_(seen_errors_31967.has(self))){
} else {
seen_errors_31967.add(self);

var temp__5804__auto___31968 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___31968)){
var sense_31969 = temp__5804__auto___31968;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_31969)].join(''));
} else {
}
}
} else {
