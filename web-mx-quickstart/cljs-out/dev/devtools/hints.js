...
var map__53686 = top_item;
var map__53686__$1 = (((((!((map__53686 == null))))?(((((map__53686.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53686.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53686):map__53686);
var file = cljs.core.get.call(null,map__53686__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__53686__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__53686__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e53685){var _e = e53685;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___53688 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___53688)){
var seen_errors_53689 = temp__5802__auto___53688;
if(cljs.core.truth_(seen_errors_53689.has(self))){
} else {
seen_errors_53689.add(self);

var temp__5804__auto___53690 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___53690)){
var sense_53691 = temp__5804__auto___53690;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_53691)].join(''));
} else {
}
}
} else {
