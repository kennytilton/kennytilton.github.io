...
var file = cljs.core.get.call(null,map__52528__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52528__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52528__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e52527){var _e = e52527;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___52530 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5802__auto___52530)){
var seen_errors_52531 = temp__5802__auto___52530;
if(cljs.core.truth_(seen_errors_52531.has(self))){
} else {
seen_errors_52531.add(self);

var temp__5804__auto___52532 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5804__auto___52532)){
var sense_52533 = temp__5804__auto___52532;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_52533)].join(''));
} else {
}
}
} else {
