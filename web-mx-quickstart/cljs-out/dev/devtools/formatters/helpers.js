...
var G__27335 = devtools.prefs.pref.call(null,v);
v = G__27335;
continue;
} else {
return v;
...
}catch (e27338){var _e__26846__auto__ = e27338;
return false;
}})();
...
}catch (e27342){var _e__26846__auto__ = e27342;
return false;
}})();
...
}catch (e27344){var _e__26846__auto__ = e27344;
return false;
}}
}
});
...
var vec__27346 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27346,(0),null);
var name = cljs.core.nth.call(null,vec__27346,(1),null);
...
return cljs.core.some.call(null,(function (p1__27349_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27349_SHARP_);
}),template);
});
