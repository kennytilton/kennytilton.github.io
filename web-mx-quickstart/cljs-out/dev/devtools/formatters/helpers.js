...
var G__27903 = devtools.prefs.pref.call(null,v);
v = G__27903;
continue;
} else {
return v;
...
}catch (e27906){var _e__27414__auto__ = e27906;
return false;
}})();
...
}catch (e27910){var _e__27414__auto__ = e27910;
return false;
}})();
...
}catch (e27912){var _e__27414__auto__ = e27912;
return false;
}}
}
});
...
var vec__27914 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27914,(0),null);
var name = cljs.core.nth.call(null,vec__27914,(1),null);
...
return cljs.core.some.call(null,(function (p1__27917_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27917_SHARP_);
}),template);
});
