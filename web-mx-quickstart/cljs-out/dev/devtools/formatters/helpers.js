...
var G__27352 = devtools.prefs.pref.call(null,v);
v = G__27352;
continue;
} else {
return v;
...
}catch (e27355){var _e__26863__auto__ = e27355;
return false;
}})();
...
}catch (e27359){var _e__26863__auto__ = e27359;
return false;
}})();
...
}catch (e27361){var _e__26863__auto__ = e27361;
return false;
}}
}
});
...
var vec__27363 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27363,(0),null);
var name = cljs.core.nth.call(null,vec__27363,(1),null);
...
return cljs.core.some.call(null,(function (p1__27366_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27366_SHARP_);
}),template);
});
