...
var G__23684 = devtools.prefs.pref.call(null,v);
v = G__23684;
continue;
} else {
return v;
...
}catch (e23687){var _e__22744__auto__ = e23687;
return false;
}})();
...
}catch (e23691){var _e__22744__auto__ = e23691;
return false;
}})();
...
}catch (e23693){var _e__22744__auto__ = e23693;
return false;
}}
}
});
...
var vec__23695 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23695,(0),null);
var name = cljs.core.nth.call(null,vec__23695,(1),null);
...
return cljs.core.some.call(null,(function (p1__23698_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23698_SHARP_);
}),template);
});
