...
var G__27934 = devtools.prefs.pref.call(null,v);
v = G__27934;
continue;
} else {
return v;
...
}catch (e27937){var _e__27445__auto__ = e27937;
return false;
}})();
...
}catch (e27941){var _e__27445__auto__ = e27941;
return false;
}})();
...
}catch (e27943){var _e__27445__auto__ = e27943;
return false;
}}
}
});
...
var vec__27945 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27945,(0),null);
var name = cljs.core.nth.call(null,vec__27945,(1),null);
...
return cljs.core.some.call(null,(function (p1__27948_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27948_SHARP_);
}),template);
});
