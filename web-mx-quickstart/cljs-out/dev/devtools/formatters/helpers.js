...
var G__27349 = devtools.prefs.pref.call(null,v);
v = G__27349;
continue;
} else {
return v;
...
}catch (e27352){var _e__26860__auto__ = e27352;
return false;
}})();
...
}catch (e27356){var _e__26860__auto__ = e27356;
return false;
}})();
...
}catch (e27358){var _e__26860__auto__ = e27358;
return false;
}}
}
});
...
var vec__27360 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27360,(0),null);
var name = cljs.core.nth.call(null,vec__27360,(1),null);
...
return cljs.core.some.call(null,(function (p1__27363_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27363_SHARP_);
}),template);
});
