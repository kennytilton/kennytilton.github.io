...
var G__34054 = devtools.prefs.pref.call(null,v);
v = G__34054;
continue;
} else {
return v;
...
}catch (e34057){var _e__33565__auto__ = e34057;
return false;
}})();
...
}catch (e34061){var _e__33565__auto__ = e34061;
return false;
}})();
...
}catch (e34063){var _e__33565__auto__ = e34063;
return false;
}}
}
});
...
var vec__34065 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__34065,(0),null);
var name = cljs.core.nth.call(null,vec__34065,(1),null);
...
return cljs.core.some.call(null,(function (p1__34068_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__34068_SHARP_);
}),template);
});
