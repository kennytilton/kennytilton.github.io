...
var G__47960 = devtools.prefs.pref.call(null,v);
v = G__47960;
continue;
} else {
return v;
...
}catch (e47963){var _e__27414__auto__ = e47963;
return false;
}})();
...
}catch (e47967){var _e__27414__auto__ = e47967;
return false;
}})();
...
}catch (e47969){var _e__27414__auto__ = e47969;
return false;
}}
}
});
...
var vec__47971 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__47971,(0),null);
var name = cljs.core.nth.call(null,vec__47971,(1),null);
...
return cljs.core.some.call(null,(function (p1__47974_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47974_SHARP_);
}),template);
});
