...
var G__27778 = devtools.prefs.pref.call(null,v);
v = G__27778;
continue;
} else {
return v;
...
}catch (e27781){var _e__27289__auto__ = e27781;
return false;
}})();
...
}catch (e27785){var _e__27289__auto__ = e27785;
return false;
}})();
...
}catch (e27787){var _e__27289__auto__ = e27787;
return false;
}}
}
});
...
var vec__27789 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__27792_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27792_SHARP_);
}),template);
});
