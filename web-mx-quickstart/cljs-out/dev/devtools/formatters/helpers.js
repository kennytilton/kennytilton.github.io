...
var G__27351 = devtools.prefs.pref.call(null,v);
v = G__27351;
continue;
} else {
return v;
...
}catch (e27354){var _e__26862__auto__ = e27354;
return false;
}})();
...
}catch (e27358){var _e__26862__auto__ = e27358;
return false;
}})();
...
}catch (e27360){var _e__26862__auto__ = e27360;
return false;
}}
}
});
...
var vec__27362 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27362,(0),null);
var name = cljs.core.nth.call(null,vec__27362,(1),null);
...
return cljs.core.some.call(null,(function (p1__27365_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27365_SHARP_);
}),template);
});
