...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27824){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27830_SHARP_){
return (!((cljs.core.meta.call(null,p1__27830_SHARP_) == null)));
})))){
...
}catch (e27835){var _e__27289__auto__ = e27835;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e27837){var _e__27289__auto__ = e27837;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27839 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27840 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27840);
...
var markup_db = cljs.core.get.call(null,map__27841__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27839);
}});
...
var temp__5802__auto___27846 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5802__auto___27846)){
var managed_print_level_27847 = temp__5802__auto___27846;
var _STAR_print_level_STAR__orig_val__27844_27848 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27845_27849 = managed_print_level_27847;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27845_27849);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__27843_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27843_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27844_27848);
}} else {
job_fn.call(null);
}
