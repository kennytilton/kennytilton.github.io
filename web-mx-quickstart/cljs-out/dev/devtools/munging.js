...
var o48997 = temp__5802__auto__;
var temp__5802__auto____$1 = (o48997["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o48998 = temp__5802__auto____$1;
return (o48998["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27741__auto__ = f;
return (o__27741__auto__["toString"]).call(o__27741__auto__);
} else {
return "";
}
}catch (e48999){var _ = e48999;
return "";
}});
...
try{var o__27741__auto___49001 = t;
(o__27741__auto___49001["cljs$lang$ctorPrWriter"]).call(o__27741__auto___49001,t,writer);
}catch (e49000){var __49002 = e49000;
}
...
var char_code = (function (){var o__27741__auto__ = (new String(char$));
return (o__27741__auto__["charCodeAt"]).call(o__27741__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27741__auto__ = String;
return (o__27741__auto__["fromCharCode"]).call(o__27741__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__49003 = num_code;
switch (G__49003) {
case (1):
return (185);
...
var o__27741__auto__ = String;
return (o__27741__auto__["fromCharCode"]).call(o__27741__auto__,superscript_code);
});
/**
...
}catch (e49005){var _e__27748__auto__ = e49005;
return false;
}})())){
...
var vec__49006 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__49006,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__49011){
var vec__49012 = p__49011;
var ns_detector = cljs.core.nth.call(null,vec__49012,(0),null);
...
var G__49018 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__49019 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__49018;
remaining_tokens = G__49019;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq49009){
var G__49010 = cljs.core.first.call(null,seq49009);
var seq49009__$1 = cljs.core.next.call(null,seq49009);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49010,seq49009__$1);
}));
...
var vec__49023 = cljs.core.split_with.call(null,(function (p1__49022_SHARP_){
return cljs.core.not_EQ_.call(null,p1__49022_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__49023,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__49023,(1),null);
...
var vec__49029 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__49029,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__49029,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__49032 = cljs.core.rest.call(null,remaining_tokens);
var G__49033 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__49032;
name_tokens = G__49033;
continue;
} else {
...
var vec__49036 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__49036,(0),null);
var arity = cljs.core.nth.call(null,vec__49036,(1),null);
var vec__49039 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__49039,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__49039,(1),null);
var vec__49042 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__49042,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__49042,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__49042,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__49042,(3),null);
...
var vec__49048 = result;
var munged_ns = cljs.core.nth.call(null,vec__49048,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__49048,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__49048,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__49048,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__49048,(4),null);
var arity = cljs.core.nth.call(null,vec__49048,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__49052 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__49052,(0),null);
var args = cljs.core.nth.call(null,vec__49052,(1),null);
var vec__49055 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__49055,(0),null);
var name = cljs.core.nth.call(null,vec__49055,(1),null);
...
var G__49058 = (arity + (1));
var G__49059 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__49060){
var vec__49061 = p__49060;
var arity = cljs.core.nth.call(null,vec__49061,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__49061,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__49064_SHARP_){
return cljs.core.get.call(null,arities,p1__49064_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__49065_SHARP_){
return cljs.core.drop.call(null,(2),p1__49065_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__49068){
var vec__49069 = p__49068;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__49069,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq49066){
var G__49067 = cljs.core.first.call(null,seq49066);
var seq49066__$1 = cljs.core.next.call(null,seq49066);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49067,seq49066__$1);
}));
...
var map__49077 = options;
var map__49077__$1 = (((((!((map__49077 == null))))?(((((map__49077.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49077.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49077):map__49077);
var include_ns_QMARK_ = cljs.core.get.call(null,map__49077__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__49077__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__49077__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__49077__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__49078 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__49078,(0),null);
var fn_name = cljs.core.nth.call(null,vec__49078,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__49078,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__49078,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__49078,(4),null);
var arity = cljs.core.nth.call(null,vec__49078,(5),null);
...
var o__27741__auto__ = f;
return (o__27741__auto__["getBasis"]).call(o__27741__auto__);
});
/**
...
}catch (e49082){var _e__27748__auto__ = e49082;
...
var G__49083 = (obj[cljs.core.first.call(null,path)]);
var G__49084 = cljs.core.rest.call(null,path);
obj = G__49083;
path = G__49084;
continue;
} else {
...
var _STAR_ = (function (accum,p__49085){
var vec__49086 = p__49085;
var bit = cljs.core.nth.call(null,vec__49086,(0),null);
var protocol = cljs.core.nth.call(null,vec__49086,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__49089){
var vec__49090 = p__49089;
var ns = cljs.core.nth.call(null,vec__49090,(0),null);
var name = cljs.core.nth.call(null,vec__49090,(1),null);
var selector = cljs.core.nth.call(null,vec__49090,(2),null);
...
var post_process = (function (p__49094){
var vec__49095 = p__49094;
var munged_name = cljs.core.nth.call(null,vec__49095,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__49095,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__49093_SHARP_){
return (obj[cljs.core.first.call(null,p1__49093_SHARP_)]);
}),sorted_matches);
