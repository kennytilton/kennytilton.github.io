...
var o27036 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27036["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27037 = temp__5802__auto____$1;
return (o27037["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26855__auto__ = f;
return (o__26855__auto__["toString"]).call(o__26855__auto__);
} else {
return "";
}
}catch (e27038){var _ = e27038;
return "";
}});
...
try{var o__26855__auto___27040 = t;
(o__26855__auto___27040["cljs$lang$ctorPrWriter"]).call(o__26855__auto___27040,t,writer);
}catch (e27039){var __27041 = e27039;
}
...
var char_code = (function (){var o__26855__auto__ = (new String(char$));
return (o__26855__auto__["charCodeAt"]).call(o__26855__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26855__auto__ = String;
return (o__26855__auto__["fromCharCode"]).call(o__26855__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27042 = num_code;
switch (G__27042) {
case (1):
return (185);
...
var o__26855__auto__ = String;
return (o__26855__auto__["fromCharCode"]).call(o__26855__auto__,superscript_code);
});
/**
...
}catch (e27044){var _e__26862__auto__ = e27044;
return false;
}})())){
...
var vec__27045 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27045,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27050){
var vec__27051 = p__27050;
var ns_detector = cljs.core.nth.call(null,vec__27051,(0),null);
...
var G__27057 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27058 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27057;
remaining_tokens = G__27058;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27048){
...
var vec__27062 = cljs.core.split_with.call(null,(function (p1__27061_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27061_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27062,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27062,(1),null);
...
var vec__27068 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27068,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27068,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27071 = cljs.core.rest.call(null,remaining_tokens);
var G__27072 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27071;
...
var vec__27075 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27075,(0),null);
var arity = cljs.core.nth.call(null,vec__27075,(1),null);
var vec__27078 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27078,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27078,(1),null);
var vec__27081 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27081,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27081,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27081,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27081,(3),null);
...
var vec__27087 = result;
var munged_ns = cljs.core.nth.call(null,vec__27087,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27087,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27087,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27087,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27087,(4),null);
var arity = cljs.core.nth.call(null,vec__27087,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27091 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27091,(0),null);
var args = cljs.core.nth.call(null,vec__27091,(1),null);
var vec__27094 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27094,(0),null);
var name = cljs.core.nth.call(null,vec__27094,(1),null);
...
var G__27097 = (arity + (1));
var G__27098 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27099){
var vec__27100 = p__27099;
var arity = cljs.core.nth.call(null,vec__27100,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27100,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27103_SHARP_){
return cljs.core.get.call(null,arities,p1__27103_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27104_SHARP_){
return cljs.core.drop.call(null,(2),p1__27104_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27107){
var vec__27108 = p__27107;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27108,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27105){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27116__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27116__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27116__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27116__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27117 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27117,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27117,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27117,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27117,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27117,(4),null);
var arity = cljs.core.nth.call(null,vec__27117,(5),null);
...
var o__26855__auto__ = f;
return (o__26855__auto__["getBasis"]).call(o__26855__auto__);
});
/**
...
}catch (e27121){var _e__26862__auto__ = e27121;
...
var G__27122 = (obj[cljs.core.first.call(null,path)]);
var G__27123 = cljs.core.rest.call(null,path);
obj = G__27122;
path = G__27123;
continue;
} else {
...
var _STAR_ = (function (accum,p__27124){
var vec__27125 = p__27124;
var bit = cljs.core.nth.call(null,vec__27125,(0),null);
var protocol = cljs.core.nth.call(null,vec__27125,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27128){
var vec__27129 = p__27128;
var ns = cljs.core.nth.call(null,vec__27129,(0),null);
var name = cljs.core.nth.call(null,vec__27129,(1),null);
var selector = cljs.core.nth.call(null,vec__27129,(2),null);
...
var post_process = (function (p__27133){
var vec__27134 = p__27133;
var munged_name = cljs.core.nth.call(null,vec__27134,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27134,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27132_SHARP_){
return (obj[cljs.core.first.call(null,p1__27132_SHARP_)]);
}),sorted_matches);
