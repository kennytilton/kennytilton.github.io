...
var o52958 = temp__5802__auto__;
var temp__5802__auto____$1 = (o52958["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o52959 = temp__5802__auto____$1;
return (o52959["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26856__auto__ = f;
return (o__26856__auto__["toString"]).call(o__26856__auto__);
} else {
return "";
}
}catch (e52960){var _ = e52960;
return "";
}});
...
try{var o__26856__auto___52962 = t;
(o__26856__auto___52962["cljs$lang$ctorPrWriter"]).call(o__26856__auto___52962,t,writer);
}catch (e52961){var __52963 = e52961;
}
...
var char_code = (function (){var o__26856__auto__ = (new String(char$));
return (o__26856__auto__["charCodeAt"]).call(o__26856__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26856__auto__ = String;
return (o__26856__auto__["fromCharCode"]).call(o__26856__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__52964 = num_code;
switch (G__52964) {
case (1):
return (185);
...
var o__26856__auto__ = String;
return (o__26856__auto__["fromCharCode"]).call(o__26856__auto__,superscript_code);
});
/**
...
}catch (e52966){var _e__26863__auto__ = e52966;
return false;
}})())){
...
var vec__52967 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__52967,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__52972){
var vec__52973 = p__52972;
var ns_detector = cljs.core.nth.call(null,vec__52973,(0),null);
...
var G__52979 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__52980 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__52979;
remaining_tokens = G__52980;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq52970){
var G__52971 = cljs.core.first.call(null,seq52970);
var seq52970__$1 = cljs.core.next.call(null,seq52970);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52971,seq52970__$1);
}));
...
var vec__52984 = cljs.core.split_with.call(null,(function (p1__52983_SHARP_){
return cljs.core.not_EQ_.call(null,p1__52983_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__52984,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__52984,(1),null);
...
var vec__52990 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__52990,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__52990,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__52993 = cljs.core.rest.call(null,remaining_tokens);
var G__52994 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__52993;
name_tokens = G__52994;
continue;
} else {
...
var vec__52997 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__52997,(0),null);
var arity = cljs.core.nth.call(null,vec__52997,(1),null);
var vec__53000 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__53000,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__53000,(1),null);
var vec__53003 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__53003,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__53003,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__53003,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__53003,(3),null);
...
var vec__53009 = result;
var munged_ns = cljs.core.nth.call(null,vec__53009,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__53009,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__53009,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__53009,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__53009,(4),null);
var arity = cljs.core.nth.call(null,vec__53009,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__53013 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__53013,(0),null);
var args = cljs.core.nth.call(null,vec__53013,(1),null);
var vec__53016 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__53016,(0),null);
var name = cljs.core.nth.call(null,vec__53016,(1),null);
...
var G__53019 = (arity + (1));
var G__53020 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53021){
var vec__53022 = p__53021;
var arity = cljs.core.nth.call(null,vec__53022,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__53022,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__53025_SHARP_){
return cljs.core.get.call(null,arities,p1__53025_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__53026_SHARP_){
return cljs.core.drop.call(null,(2),p1__53026_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53029){
var vec__53030 = p__53029;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__53030,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53027){
var G__53028 = cljs.core.first.call(null,seq53027);
var seq53027__$1 = cljs.core.next.call(null,seq53027);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53028,seq53027__$1);
}));
...
var map__53038 = options;
var map__53038__$1 = (((((!((map__53038 == null))))?(((((map__53038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53038):map__53038);
var include_ns_QMARK_ = cljs.core.get.call(null,map__53038__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__53038__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__53038__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__53038__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53039 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__53039,(0),null);
var fn_name = cljs.core.nth.call(null,vec__53039,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__53039,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__53039,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__53039,(4),null);
var arity = cljs.core.nth.call(null,vec__53039,(5),null);
...
var o__26856__auto__ = f;
return (o__26856__auto__["getBasis"]).call(o__26856__auto__);
});
/**
...
}catch (e53043){var _e__26863__auto__ = e53043;
...
var G__53044 = (obj[cljs.core.first.call(null,path)]);
var G__53045 = cljs.core.rest.call(null,path);
obj = G__53044;
path = G__53045;
continue;
} else {
...
var _STAR_ = (function (accum,p__53046){
var vec__53047 = p__53046;
var bit = cljs.core.nth.call(null,vec__53047,(0),null);
var protocol = cljs.core.nth.call(null,vec__53047,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53050){
var vec__53051 = p__53050;
var ns = cljs.core.nth.call(null,vec__53051,(0),null);
var name = cljs.core.nth.call(null,vec__53051,(1),null);
var selector = cljs.core.nth.call(null,vec__53051,(2),null);
...
var post_process = (function (p__53055){
var vec__53056 = p__53055;
var munged_name = cljs.core.nth.call(null,vec__53056,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__53056,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__53054_SHARP_){
return (obj[cljs.core.first.call(null,p1__53054_SHARP_)]);
}),sorted_matches);
