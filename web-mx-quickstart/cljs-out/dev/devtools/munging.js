...
var o27037 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27037["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27038 = temp__5802__auto____$1;
return (o27038["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__26856__auto___27041 = t;
(o__26856__auto___27041["cljs$lang$ctorPrWriter"]).call(o__26856__auto___27041,t,writer);
}catch (e27040){var __27042 = e27040;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27043 = num_code;
switch (G__27043) {
case (1):
return (185);
...
}catch (e27045){var _e__26863__auto__ = e27045;
return false;
}})())){
...
var vec__27046 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27046,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27051){
var vec__27052 = p__27051;
var ns_detector = cljs.core.nth.call(null,vec__27052,(0),null);
...
var G__27058 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27059 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27058;
remaining_tokens = G__27059;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27049){
...
var vec__27063 = cljs.core.split_with.call(null,(function (p1__27062_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27062_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27063,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27063,(1),null);
...
var vec__27069 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27069,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27069,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27072 = cljs.core.rest.call(null,remaining_tokens);
var G__27073 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27072;
name_tokens = G__27073;
continue;
} else {
...
var vec__27076 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27076,(0),null);
var arity = cljs.core.nth.call(null,vec__27076,(1),null);
var vec__27079 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27079,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27079,(1),null);
var vec__27082 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27082,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27082,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27082,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27082,(3),null);
...
var vec__27088 = result;
var munged_ns = cljs.core.nth.call(null,vec__27088,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27088,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27088,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27088,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27088,(4),null);
var arity = cljs.core.nth.call(null,vec__27088,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27092 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27092,(0),null);
var args = cljs.core.nth.call(null,vec__27092,(1),null);
var vec__27095 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27095,(0),null);
var name = cljs.core.nth.call(null,vec__27095,(1),null);
...
var G__27098 = (arity + (1));
var G__27099 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27100){
var vec__27101 = p__27100;
var arity = cljs.core.nth.call(null,vec__27101,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27101,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27104_SHARP_){
return cljs.core.get.call(null,arities,p1__27104_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27105_SHARP_){
return cljs.core.drop.call(null,(2),p1__27105_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27108){
var vec__27109 = p__27108;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27109,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27106){
...
var G__27115 = arg;
var G__27115__$1 = (((G__27115 instanceof cljs.core.Keyword))?G__27115.fqn:null);
switch (G__27115__$1) {
...
var map__27117 = options;
var map__27117__$1 = (((((!((map__27117 == null))))?(((((map__27117.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27117.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27117):map__27117);
var include_ns_QMARK_ = cljs.core.get.call(null,map__27117__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27117__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27117__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27117__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27118 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27118,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27118,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27118,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27118,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27118,(4),null);
var arity = cljs.core.nth.call(null,vec__27118,(5),null);
...
}catch (e27122){var _e__26863__auto__ = e27122;
...
var G__27123 = (obj[cljs.core.first.call(null,path)]);
var G__27124 = cljs.core.rest.call(null,path);
obj = G__27123;
path = G__27124;
continue;
} else {
...
var _STAR_ = (function (accum,p__27125){
var vec__27126 = p__27125;
var bit = cljs.core.nth.call(null,vec__27126,(0),null);
var protocol = cljs.core.nth.call(null,vec__27126,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27129){
var vec__27130 = p__27129;
var ns = cljs.core.nth.call(null,vec__27130,(0),null);
var name = cljs.core.nth.call(null,vec__27130,(1),null);
var selector = cljs.core.nth.call(null,vec__27130,(2),null);
...
var post_process = (function (p__27134){
var vec__27135 = p__27134;
var munged_name = cljs.core.nth.call(null,vec__27135,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27135,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27133_SHARP_){
return (obj[cljs.core.first.call(null,p1__27133_SHARP_)]);
}),sorted_matches);
