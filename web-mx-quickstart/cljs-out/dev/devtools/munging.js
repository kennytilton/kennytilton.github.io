...
var o26955 = temp__5802__auto__;
var temp__5802__auto____$1 = (o26955["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o26956 = temp__5802__auto____$1;
return (o26956["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26774__auto__ = f;
return (o__26774__auto__["toString"]).call(o__26774__auto__);
} else {
return "";
}
...
try{var o__26774__auto___26959 = t;
(o__26774__auto___26959["cljs$lang$ctorPrWriter"]).call(o__26774__auto___26959,t,writer);
}catch (e26958){var __26960 = e26958;
}
...
var char_code = (function (){var o__26774__auto__ = (new String(char$));
return (o__26774__auto__["charCodeAt"]).call(o__26774__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26774__auto__ = String;
return (o__26774__auto__["fromCharCode"]).call(o__26774__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26961 = num_code;
switch (G__26961) {
case (1):
return (185);
...
var o__26774__auto__ = String;
return (o__26774__auto__["fromCharCode"]).call(o__26774__auto__,superscript_code);
});
/**
...
}catch (e26963){var _e__26781__auto__ = e26963;
return false;
}})())){
...
var vec__26964 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26964,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26969){
var vec__26970 = p__26969;
var ns_detector = cljs.core.nth.call(null,vec__26970,(0),null);
...
var G__26976 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26977 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26976;
remaining_tokens = G__26977;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26967){
var G__26968 = cljs.core.first.call(null,seq26967);
var seq26967__$1 = cljs.core.next.call(null,seq26967);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26968,seq26967__$1);
}));
...
var vec__26981 = cljs.core.split_with.call(null,(function (p1__26980_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26980_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26981,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26981,(1),null);
...
var vec__26987 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26987,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26987,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26990 = cljs.core.rest.call(null,remaining_tokens);
var G__26991 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26990;
name_tokens = G__26991;
continue;
} else {
...
var vec__26994 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26994,(0),null);
var arity = cljs.core.nth.call(null,vec__26994,(1),null);
var vec__26997 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26997,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26997,(1),null);
var vec__27000 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27000,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27000,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27000,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27000,(3),null);
...
var vec__27006 = result;
var munged_ns = cljs.core.nth.call(null,vec__27006,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27006,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27006,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27006,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27006,(4),null);
var arity = cljs.core.nth.call(null,vec__27006,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27010 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27010,(0),null);
var args = cljs.core.nth.call(null,vec__27010,(1),null);
var vec__27013 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27013,(0),null);
var name = cljs.core.nth.call(null,vec__27013,(1),null);
...
var G__27016 = (arity + (1));
var G__27017 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27018){
var vec__27019 = p__27018;
var arity = cljs.core.nth.call(null,vec__27019,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27019,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27022_SHARP_){
return cljs.core.get.call(null,arities,p1__27022_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27023_SHARP_){
return cljs.core.drop.call(null,(2),p1__27023_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27026){
var vec__27027 = p__27026;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27027,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27024){
var G__27025 = cljs.core.first.call(null,seq27024);
var seq27024__$1 = cljs.core.next.call(null,seq27024);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27025,seq27024__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27035__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27035__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27035__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27035__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27036 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27036,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27036,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27036,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27036,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27036,(4),null);
var arity = cljs.core.nth.call(null,vec__27036,(5),null);
...
var o__26774__auto__ = f;
return (o__26774__auto__["getBasis"]).call(o__26774__auto__);
});
/**
...
}catch (e27040){var _e__26781__auto__ = e27040;
...
var G__27041 = (obj[cljs.core.first.call(null,path)]);
var G__27042 = cljs.core.rest.call(null,path);
obj = G__27041;
path = G__27042;
continue;
} else {
...
var _STAR_ = (function (accum,p__27043){
var vec__27044 = p__27043;
var bit = cljs.core.nth.call(null,vec__27044,(0),null);
var protocol = cljs.core.nth.call(null,vec__27044,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27047){
var vec__27048 = p__27047;
var ns = cljs.core.nth.call(null,vec__27048,(0),null);
var name = cljs.core.nth.call(null,vec__27048,(1),null);
var selector = cljs.core.nth.call(null,vec__27048,(2),null);
...
var post_process = (function (p__27052){
var vec__27053 = p__27052;
var munged_name = cljs.core.nth.call(null,vec__27053,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27053,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27051_SHARP_){
return (obj[cljs.core.first.call(null,p1__27051_SHARP_)]);
}),sorted_matches);
