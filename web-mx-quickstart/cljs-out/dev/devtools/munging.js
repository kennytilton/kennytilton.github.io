...
var o27020 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27020["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27021 = temp__5802__auto____$1;
return (o27021["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26839__auto__ = f;
return (o__26839__auto__["toString"]).call(o__26839__auto__);
} else {
return "";
}
}catch (e27022){var _ = e27022;
return "";
}});
...
try{var o__26839__auto___27024 = t;
(o__26839__auto___27024["cljs$lang$ctorPrWriter"]).call(o__26839__auto___27024,t,writer);
}catch (e27023){var __27025 = e27023;
}
...
var char_code = (function (){var o__26839__auto__ = (new String(char$));
return (o__26839__auto__["charCodeAt"]).call(o__26839__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26839__auto__ = String;
return (o__26839__auto__["fromCharCode"]).call(o__26839__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27026 = num_code;
switch (G__27026) {
case (1):
return (185);
...
var o__26839__auto__ = String;
return (o__26839__auto__["fromCharCode"]).call(o__26839__auto__,superscript_code);
});
/**
...
}catch (e27028){var _e__26846__auto__ = e27028;
return false;
}})())){
...
var vec__27029 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27029,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27034){
var vec__27035 = p__27034;
var ns_detector = cljs.core.nth.call(null,vec__27035,(0),null);
...
var G__27041 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27042 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27041;
remaining_tokens = G__27042;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27032){
...
var vec__27046 = cljs.core.split_with.call(null,(function (p1__27045_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27045_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27046,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27046,(1),null);
...
var vec__27052 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27052,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27052,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27055 = cljs.core.rest.call(null,remaining_tokens);
var G__27056 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27055;
name_tokens = G__27056;
continue;
} else {
...
var vec__27059 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27059,(0),null);
var arity = cljs.core.nth.call(null,vec__27059,(1),null);
var vec__27062 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27062,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27062,(1),null);
var vec__27065 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27065,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27065,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27065,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27065,(3),null);
...
var vec__27071 = result;
var munged_ns = cljs.core.nth.call(null,vec__27071,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27071,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27071,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27071,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27071,(4),null);
var arity = cljs.core.nth.call(null,vec__27071,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27075 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27075,(0),null);
var args = cljs.core.nth.call(null,vec__27075,(1),null);
var vec__27078 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27078,(0),null);
var name = cljs.core.nth.call(null,vec__27078,(1),null);
...
var G__27081 = (arity + (1));
var G__27082 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27083){
var vec__27084 = p__27083;
var arity = cljs.core.nth.call(null,vec__27084,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27084,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27087_SHARP_){
return cljs.core.get.call(null,arities,p1__27087_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27088_SHARP_){
return cljs.core.drop.call(null,(2),p1__27088_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27091){
var vec__27092 = p__27091;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27092,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27089){
var G__27090 = cljs.core.first.call(null,seq27089);
var seq27089__$1 = cljs.core.next.call(null,seq27089);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27090,seq27089__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27100__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27100__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27100__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27100__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27101 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27101,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27101,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27101,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27101,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27101,(4),null);
var arity = cljs.core.nth.call(null,vec__27101,(5),null);
...
var o__26839__auto__ = f;
return (o__26839__auto__["getBasis"]).call(o__26839__auto__);
});
/**
...
}catch (e27105){var _e__26846__auto__ = e27105;
...
var G__27106 = (obj[cljs.core.first.call(null,path)]);
var G__27107 = cljs.core.rest.call(null,path);
obj = G__27106;
path = G__27107;
continue;
} else {
...
var _STAR_ = (function (accum,p__27108){
var vec__27109 = p__27108;
var bit = cljs.core.nth.call(null,vec__27109,(0),null);
var protocol = cljs.core.nth.call(null,vec__27109,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27112){
var vec__27113 = p__27112;
var ns = cljs.core.nth.call(null,vec__27113,(0),null);
var name = cljs.core.nth.call(null,vec__27113,(1),null);
var selector = cljs.core.nth.call(null,vec__27113,(2),null);
...
var post_process = (function (p__27117){
var vec__27118 = p__27117;
var munged_name = cljs.core.nth.call(null,vec__27118,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27118,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27116_SHARP_){
return (obj[cljs.core.first.call(null,p1__27116_SHARP_)]);
}),sorted_matches);
