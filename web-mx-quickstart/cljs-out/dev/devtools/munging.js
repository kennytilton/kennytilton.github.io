...
var o27817 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27817["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27818 = temp__5802__auto____$1;
return (o27818["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27636__auto__ = f;
return (o__27636__auto__["toString"]).call(o__27636__auto__);
} else {
return "";
}
...
try{var o__27636__auto___27821 = t;
(o__27636__auto___27821["cljs$lang$ctorPrWriter"]).call(o__27636__auto___27821,t,writer);
}catch (e27820){var __27822 = e27820;
}
...
var char_code = (function (){var o__27636__auto__ = (new String(char$));
return (o__27636__auto__["charCodeAt"]).call(o__27636__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27636__auto__ = String;
return (o__27636__auto__["fromCharCode"]).call(o__27636__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27823 = num_code;
switch (G__27823) {
case (1):
return (185);
...
var o__27636__auto__ = String;
return (o__27636__auto__["fromCharCode"]).call(o__27636__auto__,superscript_code);
});
/**
...
}catch (e27825){var _e__27643__auto__ = e27825;
return false;
}})())){
...
var vec__27826 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27826,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27831){
var vec__27832 = p__27831;
var ns_detector = cljs.core.nth.call(null,vec__27832,(0),null);
...
var G__27838 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27839 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27838;
remaining_tokens = G__27839;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27829){
var G__27830 = cljs.core.first.call(null,seq27829);
var seq27829__$1 = cljs.core.next.call(null,seq27829);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27830,seq27829__$1);
}));
...
var vec__27843 = cljs.core.split_with.call(null,(function (p1__27842_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27842_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27843,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27843,(1),null);
...
var vec__27849 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27849,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27849,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27852 = cljs.core.rest.call(null,remaining_tokens);
var G__27853 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27852;
name_tokens = G__27853;
continue;
} else {
...
var vec__27856 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27856,(0),null);
var arity = cljs.core.nth.call(null,vec__27856,(1),null);
var vec__27859 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27859,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27859,(1),null);
var vec__27862 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27862,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27862,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27862,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27862,(3),null);
...
var vec__27868 = result;
var munged_ns = cljs.core.nth.call(null,vec__27868,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27868,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27868,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27868,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27868,(4),null);
var arity = cljs.core.nth.call(null,vec__27868,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27872 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27872,(0),null);
var args = cljs.core.nth.call(null,vec__27872,(1),null);
var vec__27875 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27875,(0),null);
var name = cljs.core.nth.call(null,vec__27875,(1),null);
...
var G__27878 = (arity + (1));
var G__27879 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27880){
var vec__27881 = p__27880;
var arity = cljs.core.nth.call(null,vec__27881,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27881,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27884_SHARP_){
return cljs.core.get.call(null,arities,p1__27884_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27885_SHARP_){
return cljs.core.drop.call(null,(2),p1__27885_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27888){
var vec__27889 = p__27888;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27889,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27886){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27897__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27897__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27897__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27897__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27898 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27898,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27898,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27898,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27898,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27898,(4),null);
var arity = cljs.core.nth.call(null,vec__27898,(5),null);
...
var o__27636__auto__ = f;
return (o__27636__auto__["getBasis"]).call(o__27636__auto__);
});
/**
...
}catch (e27902){var _e__27643__auto__ = e27902;
...
var G__27903 = (obj[cljs.core.first.call(null,path)]);
var G__27904 = cljs.core.rest.call(null,path);
obj = G__27903;
path = G__27904;
continue;
} else {
...
var _STAR_ = (function (accum,p__27905){
var vec__27906 = p__27905;
var bit = cljs.core.nth.call(null,vec__27906,(0),null);
var protocol = cljs.core.nth.call(null,vec__27906,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27909){
var vec__27910 = p__27909;
var ns = cljs.core.nth.call(null,vec__27910,(0),null);
var name = cljs.core.nth.call(null,vec__27910,(1),null);
var selector = cljs.core.nth.call(null,vec__27910,(2),null);
...
var post_process = (function (p__27914){
var vec__27915 = p__27914;
var munged_name = cljs.core.nth.call(null,vec__27915,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27915,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27913_SHARP_){
return (obj[cljs.core.first.call(null,p1__27913_SHARP_)]);
}),sorted_matches);
