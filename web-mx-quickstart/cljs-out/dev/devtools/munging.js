...
var o54673 = temp__5802__auto__;
var temp__5802__auto____$1 = (o54673["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o54674 = temp__5802__auto____$1;
return (o54674["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26853__auto__ = f;
return (o__26853__auto__["toString"]).call(o__26853__auto__);
} else {
return "";
}
}catch (e54675){var _ = e54675;
return "";
}});
...
try{var o__26853__auto___54677 = t;
(o__26853__auto___54677["cljs$lang$ctorPrWriter"]).call(o__26853__auto___54677,t,writer);
}catch (e54676){var __54678 = e54676;
}
...
var char_code = (function (){var o__26853__auto__ = (new String(char$));
return (o__26853__auto__["charCodeAt"]).call(o__26853__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26853__auto__ = String;
return (o__26853__auto__["fromCharCode"]).call(o__26853__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__54679 = num_code;
switch (G__54679) {
case (1):
return (185);
...
var o__26853__auto__ = String;
return (o__26853__auto__["fromCharCode"]).call(o__26853__auto__,superscript_code);
});
/**
...
}catch (e54681){var _e__26860__auto__ = e54681;
return false;
}})())){
...
var vec__54682 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__54682,(0),null);
...
var len__4736__auto___54691 = arguments.length;
var i__4737__auto___54692 = (0);
while(true){
if((i__4737__auto___54692 < len__4736__auto___54691)){
args__4742__auto__.push((arguments[i__4737__auto___54692]));

var G__54693 = (i__4737__auto___54692 + (1));
i__4737__auto___54692 = G__54693;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__54687){
var vec__54688 = p__54687;
var ns_detector = cljs.core.nth.call(null,vec__54688,(0),null);
...
var G__54694 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__54695 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__54694;
remaining_tokens = G__54695;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq54685){
var G__54686 = cljs.core.first.call(null,seq54685);
var seq54685__$1 = cljs.core.next.call(null,seq54685);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54686,seq54685__$1);
}));
...
var vec__54699 = cljs.core.split_with.call(null,(function (p1__54698_SHARP_){
return cljs.core.not_EQ_.call(null,p1__54698_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__54699,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__54699,(1),null);
...
var vec__54705 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__54705,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__54705,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__54708 = cljs.core.rest.call(null,remaining_tokens);
var G__54709 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__54708;
name_tokens = G__54709;
continue;
} else {
...
var vec__54712 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__54712,(0),null);
var arity = cljs.core.nth.call(null,vec__54712,(1),null);
var vec__54715 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__54715,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__54715,(1),null);
var vec__54718 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__54718,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__54718,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__54718,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__54718,(3),null);
...
var vec__54724 = result;
var munged_ns = cljs.core.nth.call(null,vec__54724,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__54724,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__54724,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__54724,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__54724,(4),null);
var arity = cljs.core.nth.call(null,vec__54724,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__54728 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__54728,(0),null);
var args = cljs.core.nth.call(null,vec__54728,(1),null);
var vec__54731 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__54731,(0),null);
var name = cljs.core.nth.call(null,vec__54731,(1),null);
...
var G__54734 = (arity + (1));
var G__54735 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__54736){
var vec__54737 = p__54736;
var arity = cljs.core.nth.call(null,vec__54737,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__54737,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__54740_SHARP_){
return cljs.core.get.call(null,arities,p1__54740_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__54741_SHARP_){
return cljs.core.drop.call(null,(2),p1__54741_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__54744){
var vec__54745 = p__54744;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__54745,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq54742){
var G__54743 = cljs.core.first.call(null,seq54742);
var seq54742__$1 = cljs.core.next.call(null,seq54742);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54743,seq54742__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__54753__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__54753__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__54753__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__54753__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__54754 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__54754,(0),null);
var fn_name = cljs.core.nth.call(null,vec__54754,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__54754,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__54754,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__54754,(4),null);
var arity = cljs.core.nth.call(null,vec__54754,(5),null);
...
var o__26853__auto__ = f;
return (o__26853__auto__["getBasis"]).call(o__26853__auto__);
});
/**
...
}catch (e54758){var _e__26860__auto__ = e54758;
...
var G__54759 = (obj[cljs.core.first.call(null,path)]);
var G__54760 = cljs.core.rest.call(null,path);
obj = G__54759;
path = G__54760;
continue;
} else {
...
var _STAR_ = (function (accum,p__54761){
var vec__54762 = p__54761;
var bit = cljs.core.nth.call(null,vec__54762,(0),null);
var protocol = cljs.core.nth.call(null,vec__54762,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__54765){
var vec__54766 = p__54765;
var ns = cljs.core.nth.call(null,vec__54766,(0),null);
var name = cljs.core.nth.call(null,vec__54766,(1),null);
var selector = cljs.core.nth.call(null,vec__54766,(2),null);
...
var post_process = (function (p__54770){
var vec__54771 = p__54770;
var munged_name = cljs.core.nth.call(null,vec__54771,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__54771,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__54769_SHARP_){
return (obj[cljs.core.first.call(null,p1__54769_SHARP_)]);
}),sorted_matches);
