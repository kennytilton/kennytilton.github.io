...
var o33739 = temp__5802__auto__;
var temp__5802__auto____$1 = (o33739["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o33740 = temp__5802__auto____$1;
return (o33740["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33558__auto__ = f;
return (o__33558__auto__["toString"]).call(o__33558__auto__);
} else {
return "";
}
}catch (e33741){var _ = e33741;
return "";
}});
...
try{var o__33558__auto___33743 = t;
(o__33558__auto___33743["cljs$lang$ctorPrWriter"]).call(o__33558__auto___33743,t,writer);
}catch (e33742){var __33744 = e33742;
}
...
var char_code = (function (){var o__33558__auto__ = (new String(char$));
return (o__33558__auto__["charCodeAt"]).call(o__33558__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33558__auto__ = String;
return (o__33558__auto__["fromCharCode"]).call(o__33558__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33745 = num_code;
switch (G__33745) {
case (1):
return (185);
...
var o__33558__auto__ = String;
return (o__33558__auto__["fromCharCode"]).call(o__33558__auto__,superscript_code);
});
/**
...
}catch (e33747){var _e__33565__auto__ = e33747;
return false;
}})())){
...
var vec__33748 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33748,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33753){
var vec__33754 = p__33753;
var ns_detector = cljs.core.nth.call(null,vec__33754,(0),null);
...
var G__33760 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33761 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33760;
remaining_tokens = G__33761;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33751){
var G__33752 = cljs.core.first.call(null,seq33751);
var seq33751__$1 = cljs.core.next.call(null,seq33751);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33752,seq33751__$1);
}));
...
var vec__33765 = cljs.core.split_with.call(null,(function (p1__33764_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33764_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33765,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33765,(1),null);
...
var vec__33771 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33771,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33771,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33774 = cljs.core.rest.call(null,remaining_tokens);
var G__33775 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
...
var vec__33778 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33778,(0),null);
var arity = cljs.core.nth.call(null,vec__33778,(1),null);
var vec__33781 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33781,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33781,(1),null);
var vec__33784 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33784,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33784,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33784,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33784,(3),null);
...
var vec__33790 = result;
var munged_ns = cljs.core.nth.call(null,vec__33790,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33790,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33790,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33790,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33790,(4),null);
var arity = cljs.core.nth.call(null,vec__33790,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__33794 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__33794,(0),null);
var args = cljs.core.nth.call(null,vec__33794,(1),null);
var vec__33797 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33797,(0),null);
...
var G__33800 = (arity + (1));
var G__33801 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33802){
var vec__33803 = p__33802;
var arity = cljs.core.nth.call(null,vec__33803,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33803,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33806_SHARP_){
return cljs.core.get.call(null,arities,p1__33806_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__33807_SHARP_){
return cljs.core.drop.call(null,(2),p1__33807_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___33814 = arguments.length;
var i__4737__auto___33815 = (0);
while(true){
if((i__4737__auto___33815 < len__4736__auto___33814)){
args__4742__auto__.push((arguments[i__4737__auto___33815]));

var G__33816 = (i__4737__auto___33815 + (1));
i__4737__auto___33815 = G__33816;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33810){
var vec__33811 = p__33810;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33811,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33808){
var G__33809 = cljs.core.first.call(null,seq33808);
var seq33808__$1 = cljs.core.next.call(null,seq33808);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33809,seq33808__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33819__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33819__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33819__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33819__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33820 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33820,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33820,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33820,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33820,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33820,(4),null);
...
var o__33558__auto__ = f;
return (o__33558__auto__["getBasis"]).call(o__33558__auto__);
});
/**
...
}catch (e33824){var _e__33565__auto__ = e33824;
...
var G__33825 = (obj[cljs.core.first.call(null,path)]);
var G__33826 = cljs.core.rest.call(null,path);
obj = G__33825;
path = G__33826;
continue;
} else {
...
var _STAR_ = (function (accum,p__33827){
var vec__33828 = p__33827;
var bit = cljs.core.nth.call(null,vec__33828,(0),null);
var protocol = cljs.core.nth.call(null,vec__33828,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33831){
var vec__33832 = p__33831;
var ns = cljs.core.nth.call(null,vec__33832,(0),null);
var name = cljs.core.nth.call(null,vec__33832,(1),null);
var selector = cljs.core.nth.call(null,vec__33832,(2),null);
...
var post_process = (function (p__33836){
var vec__33837 = p__33836;
var munged_name = cljs.core.nth.call(null,vec__33837,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33837,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33835_SHARP_){
return (obj[cljs.core.first.call(null,p1__33835_SHARP_)]);
}),sorted_matches);
