...
var o27029 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27029["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27030 = temp__5802__auto____$1;
return (o27030["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26848__auto__ = f;
return (o__26848__auto__["toString"]).call(o__26848__auto__);
} else {
return "";
}
}catch (e27031){var _ = e27031;
return "";
}});
...
try{var o__26848__auto___27033 = t;
(o__26848__auto___27033["cljs$lang$ctorPrWriter"]).call(o__26848__auto___27033,t,writer);
}catch (e27032){var __27034 = e27032;
}
...
var char_code = (function (){var o__26848__auto__ = (new String(char$));
return (o__26848__auto__["charCodeAt"]).call(o__26848__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26848__auto__ = String;
return (o__26848__auto__["fromCharCode"]).call(o__26848__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27035 = num_code;
switch (G__27035) {
case (1):
return (185);
...
var o__26848__auto__ = String;
return (o__26848__auto__["fromCharCode"]).call(o__26848__auto__,superscript_code);
});
/**
...
}catch (e27037){var _e__26855__auto__ = e27037;
return false;
}})())){
...
var vec__27038 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27038,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27043){
var vec__27044 = p__27043;
var ns_detector = cljs.core.nth.call(null,vec__27044,(0),null);
...
var G__27050 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27051 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27050;
remaining_tokens = G__27051;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27041){
var G__27042 = cljs.core.first.call(null,seq27041);
var seq27041__$1 = cljs.core.next.call(null,seq27041);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27042,seq27041__$1);
}));
...
var vec__27055 = cljs.core.split_with.call(null,(function (p1__27054_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27054_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27055,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27055,(1),null);
...
var vec__27061 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27061,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27061,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27064 = cljs.core.rest.call(null,remaining_tokens);
var G__27065 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27064;
name_tokens = G__27065;
continue;
} else {
...
var vec__27068 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27068,(0),null);
var arity = cljs.core.nth.call(null,vec__27068,(1),null);
var vec__27071 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27071,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27071,(1),null);
var vec__27074 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27074,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27074,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27074,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27074,(3),null);
...
var vec__27080 = result;
var munged_ns = cljs.core.nth.call(null,vec__27080,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27080,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27080,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27080,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27080,(4),null);
var arity = cljs.core.nth.call(null,vec__27080,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27084 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27084,(0),null);
var args = cljs.core.nth.call(null,vec__27084,(1),null);
var vec__27087 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27087,(0),null);
var name = cljs.core.nth.call(null,vec__27087,(1),null);
...
var G__27090 = (arity + (1));
var G__27091 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27092){
var vec__27093 = p__27092;
var arity = cljs.core.nth.call(null,vec__27093,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27093,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27096_SHARP_){
return cljs.core.get.call(null,arities,p1__27096_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27097_SHARP_){
return cljs.core.drop.call(null,(2),p1__27097_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27100){
var vec__27101 = p__27100;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27101,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27098){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27109__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27109__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27109__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27109__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27110 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27110,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27110,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27110,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27110,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27110,(4),null);
var arity = cljs.core.nth.call(null,vec__27110,(5),null);
...
var o__26848__auto__ = f;
return (o__26848__auto__["getBasis"]).call(o__26848__auto__);
});
/**
...
}catch (e27114){var _e__26855__auto__ = e27114;
...
var G__27115 = (obj[cljs.core.first.call(null,path)]);
var G__27116 = cljs.core.rest.call(null,path);
obj = G__27115;
path = G__27116;
continue;
} else {
...
var _STAR_ = (function (accum,p__27117){
var vec__27118 = p__27117;
var bit = cljs.core.nth.call(null,vec__27118,(0),null);
var protocol = cljs.core.nth.call(null,vec__27118,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27121){
var vec__27122 = p__27121;
var ns = cljs.core.nth.call(null,vec__27122,(0),null);
var name = cljs.core.nth.call(null,vec__27122,(1),null);
var selector = cljs.core.nth.call(null,vec__27122,(2),null);
...
var post_process = (function (p__27126){
var vec__27127 = p__27126;
var munged_name = cljs.core.nth.call(null,vec__27127,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27127,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27125_SHARP_){
return (obj[cljs.core.first.call(null,p1__27125_SHARP_)]);
}),sorted_matches);
