...
var o27034 = temp__5802__auto__;
var temp__5802__auto____$1 = (o27034["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o27035 = temp__5802__auto____$1;
return (o27035["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__26853__auto___27038 = t;
(o__26853__auto___27038["cljs$lang$ctorPrWriter"]).call(o__26853__auto___27038,t,writer);
}catch (e27037){var __27039 = e27037;
}
...
}catch (e27042){var _e__26860__auto__ = e27042;
return false;
}})())){
...
var vec__27043 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27043,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27048){
var vec__27049 = p__27048;
var ns_detector = cljs.core.nth.call(null,vec__27049,(0),null);
...
var G__27055 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27056 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27055;
remaining_tokens = G__27056;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27046){
var G__27047 = cljs.core.first.call(null,seq27046);
var seq27046__$1 = cljs.core.next.call(null,seq27046);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27047,seq27046__$1);
}));
...
var vec__27060 = cljs.core.split_with.call(null,(function (p1__27059_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27059_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27060,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27060,(1),null);
...
var vec__27066 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27066,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27066,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27069 = cljs.core.rest.call(null,remaining_tokens);
var G__27070 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27069;
name_tokens = G__27070;
continue;
} else {
...
var vec__27073 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27073,(0),null);
var arity = cljs.core.nth.call(null,vec__27073,(1),null);
var vec__27076 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27076,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27076,(1),null);
var vec__27079 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27079,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27079,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27079,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27079,(3),null);
...
var vec__27085 = result;
var munged_ns = cljs.core.nth.call(null,vec__27085,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27085,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27085,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27085,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27085,(4),null);
var arity = cljs.core.nth.call(null,vec__27085,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27089 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__27089,(0),null);
var args = cljs.core.nth.call(null,vec__27089,(1),null);
var vec__27092 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27092,(0),null);
var name = cljs.core.nth.call(null,vec__27092,(1),null);
...
var G__27095 = (arity + (1));
var G__27096 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27097){
var vec__27098 = p__27097;
var arity = cljs.core.nth.call(null,vec__27098,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27098,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27101_SHARP_){
return cljs.core.get.call(null,arities,p1__27101_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__27102_SHARP_){
return cljs.core.drop.call(null,(2),p1__27102_SHARP_);
}),sorted_infos);
...
args__4742__auto__.push((arguments[i__4737__auto___27110]));

var G__27111 = (i__4737__auto___27110 + (1));
i__4737__auto___27110 = G__27111;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27105){
var vec__27106 = p__27105;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27106,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27103){
var G__27104 = cljs.core.first.call(null,seq27103);
var seq27103__$1 = cljs.core.next.call(null,seq27103);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27104,seq27103__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27114__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27115 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27115,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27115,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27115,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27115,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27115,(4),null);
var arity = cljs.core.nth.call(null,vec__27115,(5),null);
...
}catch (e27119){var _e__26860__auto__ = e27119;
...
var G__27120 = (obj[cljs.core.first.call(null,path)]);
var G__27121 = cljs.core.rest.call(null,path);
obj = G__27120;
path = G__27121;
continue;
} else {
...
var _STAR_ = (function (accum,p__27122){
var vec__27123 = p__27122;
var bit = cljs.core.nth.call(null,vec__27123,(0),null);
var protocol = cljs.core.nth.call(null,vec__27123,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27126){
var vec__27127 = p__27126;
var ns = cljs.core.nth.call(null,vec__27127,(0),null);
var name = cljs.core.nth.call(null,vec__27127,(1),null);
var selector = cljs.core.nth.call(null,vec__27127,(2),null);
...
var post_process = (function (p__27131){
var vec__27132 = p__27131;
var munged_name = cljs.core.nth.call(null,vec__27132,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27132,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__27130_SHARP_){
return (obj[cljs.core.first.call(null,p1__27130_SHARP_)]);
}),sorted_matches);
