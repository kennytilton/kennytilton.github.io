...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_17602 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_17602(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_17603 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_17603(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_17604 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_17604(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_17605 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_17605(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_17606 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_17606(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_17607 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_17607(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_17608 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_17608(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_17609 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_17609(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_17610 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_17610(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_17611 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_17611(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_17612 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_17612(b);
}
});
