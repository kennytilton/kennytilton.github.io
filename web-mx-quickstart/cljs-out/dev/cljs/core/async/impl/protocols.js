...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10426 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10426(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10427 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10427(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10428 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10428(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10429 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10429(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10430 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10430(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10431 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10431(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10432 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10432(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10433 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10433(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10434 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10434(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10435 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10435(b,itm);
}
});
