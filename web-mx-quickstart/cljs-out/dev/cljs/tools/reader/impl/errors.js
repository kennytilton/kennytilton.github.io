...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq26127){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26128,G__26129,seq26127__$2);
}));
...
var G__26137 = (i__4737__auto___26136 + (1));
i__4737__auto___26136 = G__26137;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq26133){
var G__26134 = cljs.core.first(seq26133);
var seq26133__$1 = cljs.core.next(seq26133);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26134,seq26133__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq26138){
var G__26139 = cljs.core.first(seq26138);
var seq26138__$1 = cljs.core.next(seq26138);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26139,seq26138__$1);
}));
...
var i__4737__auto___26146 = (0);
while(true){
if((i__4737__auto___26146 < len__4736__auto___26145)){
args__4742__auto__.push((arguments[i__4737__auto___26146]));

var G__26147 = (i__4737__auto___26146 + (1));
i__4737__auto___26146 = G__26147;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq26143){
var G__26144 = cljs.core.first(seq26143);
var seq26143__$1 = cljs.core.next(seq26143);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26144,seq26143__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___26155 = arguments.length;
var i__4737__auto___26156 = (0);
while(true){
if((i__4737__auto___26156 < len__4736__auto___26155)){
args__4742__auto__.push((arguments[i__4737__auto___26156]));

var G__26157 = (i__4737__auto___26156 + (1));
i__4737__auto___26156 = G__26157;
continue;
} else {
}
break;
...
var init = (function (){var G__26154 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26154__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq26151){
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26169(s__26170){
return (new cljs.core.LazySeq(null,(function (){
var s__26170__$1 = s__26170;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26170__$1);
if(temp__5804__auto__){
var s__26170__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26170__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__26170__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__26172 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__26171 = (0);
while(true){
if((i__26171 < size__4528__auto__)){
var vec__26173 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__26171);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26173,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26173,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__26172,id);

var G__26179 = (i__26171 + (1));
i__26171 = G__26179;
continue;
} else {
var G__26180 = (i__26171 + (1));
i__26171 = G__26180;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26172),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26169(cljs.core.chunk_rest(s__26170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26172),null);
}
} else {
var vec__26176 = cljs.core.first(s__26170__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26176,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26176,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26169(cljs.core.rest(s__26170__$2)));
} else {
var G__26181 = cljs.core.rest(s__26170__$2);
s__26170__$1 = G__26181;
continue;
}
}
} else {
