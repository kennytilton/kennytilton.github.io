...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26283 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26283(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26284 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26284(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26285 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26285(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26286 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26286(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26287 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26287(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26288 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26288(reader);
}
});
...
var G__26299 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26300 = s.append(c);
c = G__26299;
s = G__26300;
continue;
}
