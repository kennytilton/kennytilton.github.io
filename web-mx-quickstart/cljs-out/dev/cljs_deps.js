...
goog.addDependency("../tiltontec/util/core.js", ['tiltontec.util.core'], ['cljs.core', 'tiltontec.util.base', 'clojure.string']);
...
goog.addDependency("../tiltontec/cell/poly.js", ['tiltontec.cell.poly'], ['cljs.core', 'tiltontec.util.base']);
goog.addDependency("../tiltontec/cell/watch.js", ['tiltontec.cell.watch'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'tiltontec.cell.poly']);
goog.addDependency("../tiltontec/cell/diagnostic.js", ['tiltontec.cell.diagnostic'], ['tiltontec.cell.base', 'cljs.core', 'clojure.set', 'clojure.string']);
...
goog.addDependency("../tiltontec/cell/evaluate.js", ['tiltontec.cell.evaluate'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'clojure.set', 'tiltontec.cell.watch', 'cljs.pprint', 'tiltontec.util.base', 'tiltontec.cell.poly', 'tiltontec.cell.diagnostic', 'tiltontec.cell.integrity', 'clojure.string']);
goog.addDependency("../tiltontec/cell/core.js", ['tiltontec.cell.core'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'tiltontec.cell.evaluate', 'cljs.pprint', 'tiltontec.util.base', 'tiltontec.cell.integrity', 'clojure.string']);
goog.addDependency("../tiltontec/model/base.js", ['tiltontec.model.base'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'cljs.test', 'tiltontec.cell.evaluate', 'tiltontec.cell.core', 'tiltontec.util.base', 'tiltontec.cell.poly', 'tiltontec.cell.integrity']);
goog.addDependency("../tiltontec/model/core.js", ['tiltontec.model.core'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'tiltontec.cell.evaluate', 'tiltontec.model.base', 'tiltontec.cell.core', 'clojure.set', 'tiltontec.util.base', 'tiltontec.cell.poly', 'tiltontec.cell.diagnostic', 'tiltontec.cell.integrity']);
goog.addDependency("../tiltontec/matrix/api.js", ['tiltontec.matrix.api'], ['tiltontec.cell.base', 'tiltontec.util.core', 'cljs.core', 'tiltontec.cell.core', 'tiltontec.model.core', 'tiltontec.util.base', 'tiltontec.cell.diagnostic']);
goog.addDependency("../tiltontec/web_mx/base.js", ['tiltontec.web_mx.base'], ['goog.dom', 'cljs.core', 'tiltontec.matrix.api', 'clojure.string']);
...
goog.addDependency("../tiltontec/web_mx/style.js", ['tiltontec.web_mx.style'], ['tiltontec.web_mx.base', 'cljs.core', 'tiltontec.matrix.api', 'tiltontec.cell.poly', 'goog.style', 'clojure.string']);
goog.addDependency("../tiltontec/web_mx/html.js", ['tiltontec.web_mx.html'], ['goog.dom', 'goog.dom.classlist', 'tiltontec.web_mx.base', 'cljs.core', 'clojure.set', 'tiltontec.matrix.api', 'tiltontec.cell.poly', 'goog.html.sanitizer.HtmlSanitizer', 'clojure.string', 'tiltontec.web_mx.style']);
goog.addDependency("../tiltontec/web_mx/gen.js", ['tiltontec.web_mx.gen'], ['goog.dom.forms', 'cljs.core', 'tiltontec.matrix.api', 'tiltontec.cell.poly', 'clojure.string']);
goog.addDependency("../tiltontec/web_mx/api.js", ['tiltontec.web_mx.api'], ['goog.dom.forms', 'goog.dom', 'goog.dom.classlist', 'goog.editor.focus', 'tiltontec.web_mx.base', 'cljs.core', 'goog.object', 'tiltontec.matrix.api', 'tiltontec.web_mx.html', 'tiltontec.cell.poly', 'goog.html.sanitizer.HtmlSanitizer', 'goog.style', 'goog.dom.selection', 'clojure.string', 'clojure.walk', 'tiltontec.web_mx.gen']);
goog.addDependency("../web_mx_quickstart/extra.js", ['web_mx_quickstart.extra'], ['tiltontec.web_mx.api', 'cljs.core']);
...
goog.addDependency("../web_mx_quickstart/lesson.js", ['web_mx_quickstart.lesson'], ['tiltontec.web_mx.api', 'cljs.core', 'cljs_http.client', 'cljs.core.async', 'tiltontec.matrix.api', 'cljs.pprint', 'clojure.string']);
...
goog.addDependency("../web_mx_quickstart/core.js", ['web_mx_quickstart.core'], ['goog.dom', 'tiltontec.web_mx.api', 'cljs.core', 'goog.object', 'web_mx_quickstart.lesson', 'web_mx_quickstart.extra', 'tiltontec.matrix.api', 'bide.core']);
