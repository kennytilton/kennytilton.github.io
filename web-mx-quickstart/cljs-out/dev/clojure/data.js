...
return cljs.core.reduce.call(null,(function (result,p__29799){
...
var vec__29803 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__29803,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__29803,(1),null);
var ab = cljs.core.nth.call(null,vec__29803,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29809 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29809.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_29810 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_29810.call(null,a,b);
}
});
...
return (function (){var G__29814 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29814__$1)].join('')));
