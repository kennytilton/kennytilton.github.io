...
return cljs.core.reduce.call(null,(function (result,p__27702){
var vec__27703 = p__27702;
var k = cljs.core.nth.call(null,vec__27703,(0),null);
var v = cljs.core.nth.call(null,vec__27703,(1),null);
...
var vec__27706 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__27706,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__27706,(1),null);
var ab = cljs.core.nth.call(null,vec__27706,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27712 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27712.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27713 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27713.call(null,a,b);
}
});
...
return (function (){var G__27717 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27717__$1)].join('')));
