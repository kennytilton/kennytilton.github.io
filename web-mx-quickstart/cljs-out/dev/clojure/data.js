...
return cljs.core.reduce.call(null,(function (result,p__36992){
...
var vec__36996 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__36996,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__36996,(1),null);
var ab = cljs.core.nth.call(null,vec__36996,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_37002 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_37002.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_37003 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_37003.call(null,a,b);
}
});
...
return (function (){var G__37007 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37007__$1)].join('')));
