...
cljs.core.chunk_append(b__27926,k);

var G__27936 = (i__27925 + (1));
i__27925 = G__27936;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27926),tiltontec$web_mx$style$iter__27923(cljs.core.chunk_rest(s__27924__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27926),null);
}
} else {
var vec__27930 = cljs.core.first(s__27924__$2);
...
return cljs.core.cons(k,tiltontec$web_mx$style$iter__27923(cljs.core.rest(s__27924__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(tiltontec.web_mx.style.make_css_inline.cljs$lang$applyTo = (function (seq27921){
var G__27922 = cljs.core.first(seq27921);
var seq27921__$1 = cljs.core.next(seq27921);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27922,seq27921__$1);
}));

tiltontec.web_mx.style.style_string = (function tiltontec$web_mx$style$style_string(s){
var ss = ((typeof s === 'string')?s:(((s == null))?"":((cljs.core.map_QMARK_(s))?clojure.string.join.cljs$core$IFn$_invoke$arity$2(";",(function (){var iter__4529__auto__ = (function tiltontec$web_mx$style$style_string_$_iter__27937(s__27938){
return (new cljs.core.LazySeq(null,(function (){
...
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27941,(1),null);
if(cljs.core.truth_(v)){
cljs.core.chunk_append(b__27940,cljs.pprint.cl_format.cljs$core$IFn$_invoke$arity$variadic(null,"~a:~a",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.name(k),tiltontec.web_mx.base.kw$(v)], 0)));

var G__27948 = (i__27939 + (1));
i__27939 = G__27948;
continue;
} else {
var G__27949 = (i__27939 + (1));
i__27939 = G__27949;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27940),tiltontec$web_mx$style$style_string_$_iter__27937(cljs.core.chunk_rest(s__27938__$2)));
} else {
...
if(cljs.core.truth_(v)){
return cljs.core.cons(cljs.pprint.cl_format.cljs$core$IFn$_invoke$arity$variadic(null,"~a:~a",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.name(k),tiltontec.web_mx.base.kw$(v)], 0)),tiltontec$web_mx$style$style_string_$_iter__27937(cljs.core.rest(s__27938__$2)));
} else {
var G__27950 = cljs.core.rest(s__27938__$2);
s__27938__$1 = G__27950;
continue;
}
}
} else {
...
})()):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$web_DASH_mx$css_SLASH_css,tiltontec.cell.base.ia_type(s)))?(function (){var G__27947 = cljs.core.select_keys(cljs.core.deref(s),cljs.core.cst$kw$css_DASH_keys.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(s)));
return (tiltontec.web_mx.style.style_string.cljs$core$IFn$_invoke$arity$1 ? tiltontec.web_mx.style.style_string.cljs$core$IFn$_invoke$arity$1(G__27947) : tiltontec.web_mx.style.style_string.call(null,G__27947));
})():(function (){
