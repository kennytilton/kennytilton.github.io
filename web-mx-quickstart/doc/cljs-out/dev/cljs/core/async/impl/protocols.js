...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_24339 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_24339(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_24340 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_24340(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_24341 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_24341(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_24342 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_24342(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_24343 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_24343(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_24344 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_24344(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_24345 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_24345(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_24346 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_24346(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_24347 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_24347(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_24348 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_24348(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_24349 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_24349(b);
}
});
