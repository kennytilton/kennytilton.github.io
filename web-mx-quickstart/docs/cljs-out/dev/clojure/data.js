...
return cljs.core.reduce.call(null,(function (result,p__29777){
...
var vec__29781 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__29781,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__29781,(1),null);
var ab = cljs.core.nth.call(null,vec__29781,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29787 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29787.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_29788 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_29788.call(null,a,b);
}
});
...
return (function (){var G__29792 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29792__$1)].join('')));
