...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_17721 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_17721(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_17722 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_17722(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17723 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17723(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17724 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17724(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17725 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17725(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17726 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17726(reader);
}
});
...
var G__17737 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__17738 = s.append(c);
c = G__17737;
s = G__17738;
continue;
}
