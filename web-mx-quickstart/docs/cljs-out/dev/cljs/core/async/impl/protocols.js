...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_17622 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_17622(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_17623 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_17623(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_17624 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_17624(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_17625 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_17625(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_17626 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_17626(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_17627 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_17627(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_17628 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_17628(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_17629 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_17629(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_17630 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_17630(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_17631 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_17631(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_17632 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_17632(b);
}
});
