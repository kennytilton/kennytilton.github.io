...
return html_coll.item(p1__8852_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__8853_SHARP_);
...
var ctx_8854 = cvs.getContext("2d");
(ctx_8854.fillStyle = color);

ctx_8854.fillRect((0),(0),size,size);
