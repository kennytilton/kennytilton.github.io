...
var c_30725 = (new goog.debug.Console());
var G__30724_30726 = c_30725.getFormatter();
goog.object.set(G__30724_30726,"showAbsoluteTime",false);

goog.object.set(G__30724_30726,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_30725);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__30727_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__30727_SHARP_);
