...
var o33892 = temp__5802__auto__;
var temp__5802__auto____$1 = (o33892["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o33893 = temp__5802__auto____$1;
return (o33893["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33711__auto__ = f;
return (o__33711__auto__["toString"]).call(o__33711__auto__);
} else {
return "";
}
}catch (e33894){var _ = e33894;
return "";
}});
...
try{var o__33711__auto___33896 = t;
(o__33711__auto___33896["cljs$lang$ctorPrWriter"]).call(o__33711__auto___33896,t,writer);
}catch (e33895){var __33897 = e33895;
}
...
var char_code = (function (){var o__33711__auto__ = (new String(char$));
return (o__33711__auto__["charCodeAt"]).call(o__33711__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33711__auto__ = String;
return (o__33711__auto__["fromCharCode"]).call(o__33711__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33898 = num_code;
switch (G__33898) {
case (1):
return (185);
...
var o__33711__auto__ = String;
return (o__33711__auto__["fromCharCode"]).call(o__33711__auto__,superscript_code);
});
/**
...
}catch (e33900){var _e__33718__auto__ = e33900;
return false;
}})())){
...
var vec__33901 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33901,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33906){
var vec__33907 = p__33906;
var ns_detector = cljs.core.nth.call(null,vec__33907,(0),null);
...
var G__33913 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33914 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33913;
remaining_tokens = G__33914;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33904){
var G__33905 = cljs.core.first.call(null,seq33904);
var seq33904__$1 = cljs.core.next.call(null,seq33904);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33905,seq33904__$1);
}));
...
var vec__33918 = cljs.core.split_with.call(null,(function (p1__33917_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33917_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33918,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33918,(1),null);
...
var vec__33924 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33924,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33924,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33927 = cljs.core.rest.call(null,remaining_tokens);
var G__33928 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33927;
name_tokens = G__33928;
continue;
} else {
...
var vec__33931 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33931,(0),null);
var arity = cljs.core.nth.call(null,vec__33931,(1),null);
var vec__33934 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33934,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33934,(1),null);
var vec__33937 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33937,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33937,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33937,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33937,(3),null);
...
var vec__33943 = result;
var munged_ns = cljs.core.nth.call(null,vec__33943,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33943,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33943,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33943,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33943,(4),null);
var arity = cljs.core.nth.call(null,vec__33943,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__33947 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__33947,(0),null);
var args = cljs.core.nth.call(null,vec__33947,(1),null);
var vec__33950 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33950,(0),null);
var name = cljs.core.nth.call(null,vec__33950,(1),null);
...
var G__33953 = (arity + (1));
var G__33954 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33955){
var vec__33956 = p__33955;
var arity = cljs.core.nth.call(null,vec__33956,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33956,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33959_SHARP_){
return cljs.core.get.call(null,arities,p1__33959_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__33960_SHARP_){
return cljs.core.drop.call(null,(2),p1__33960_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___33967 = arguments.length;
var i__4737__auto___33968 = (0);
while(true){
if((i__4737__auto___33968 < len__4736__auto___33967)){
args__4742__auto__.push((arguments[i__4737__auto___33968]));

var G__33969 = (i__4737__auto___33968 + (1));
i__4737__auto___33968 = G__33969;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33963){
var vec__33964 = p__33963;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33964,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33961){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33972__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33972__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33972__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33972__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33973 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33973,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33973,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33973,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33973,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33973,(4),null);
var arity = cljs.core.nth.call(null,vec__33973,(5),null);
...
var o__33711__auto__ = f;
return (o__33711__auto__["getBasis"]).call(o__33711__auto__);
});
/**
...
}catch (e33977){var _e__33718__auto__ = e33977;
