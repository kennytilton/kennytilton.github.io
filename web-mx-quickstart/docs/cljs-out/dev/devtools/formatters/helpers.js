...
var G__34207 = devtools.prefs.pref.call(null,v);
v = G__34207;
continue;
} else {
return v;
...
}catch (e34210){var _e__33718__auto__ = e34210;
return false;
}})();
...
}catch (e34214){var _e__33718__auto__ = e34214;
return false;
}})();
...
}catch (e34216){var _e__33718__auto__ = e34216;
return false;
}}
}
});
...
var vec__34218 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__34218,(0),null);
var name = cljs.core.nth.call(null,vec__34218,(1),null);
...
return cljs.core.some.call(null,(function (p1__34221_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__34221_SHARP_);
}),template);
});
