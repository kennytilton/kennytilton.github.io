...
var G__27330 = devtools.prefs.pref.call(null,v);
v = G__27330;
continue;
} else {
return v;
...
}catch (e27333){var _e__26841__auto__ = e27333;
return false;
}})();
...
}catch (e27337){var _e__26841__auto__ = e27337;
return false;
}})();
...
}catch (e27339){var _e__26841__auto__ = e27339;
return false;
}}
}
});
...
var vec__27341 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27341,(0),null);
var name = cljs.core.nth.call(null,vec__27341,(1),null);
...
return cljs.core.some.call(null,(function (p1__27344_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27344_SHARP_);
}),template);
});
