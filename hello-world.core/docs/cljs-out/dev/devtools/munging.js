...
var o10774 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10774["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10775 = temp__5718__auto____$1;
return (o10775["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10696__auto__ = f;
return (o__10696__auto__["toString"]).call(o__10696__auto__);
} else {
return "";
}
}catch (e10776){var _ = e10776;
return "";
}});
...
try{var o__10696__auto___10778 = t;
(o__10696__auto___10778["cljs$lang$ctorPrWriter"]).call(o__10696__auto___10778,t,writer);
}catch (e10777){var __10779 = e10777;
}
...
var char_code = (function (){var o__10696__auto__ = (new String(char$));
return (o__10696__auto__["charCodeAt"]).call(o__10696__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10696__auto__ = String;
return (o__10696__auto__["fromCharCode"]).call(o__10696__auto__,subscript_code);
});
/**
...
var o__10696__auto__ = String;
return (o__10696__auto__["fromCharCode"]).call(o__10696__auto__,superscript_code);
});
/**
...
}catch (e10782){var _e__10703__auto__ = e10782;
return false;
}})())){
...
var vec__10783 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10783,(0),null);
...
var len__4864__auto___10792 = arguments.length;
var i__4865__auto___10793 = (0);
while(true){
if((i__4865__auto___10793 < len__4864__auto___10792)){
args__4870__auto__.push((arguments[i__4865__auto___10793]));

var G__10794 = (i__4865__auto___10793 + (1));
i__4865__auto___10793 = G__10794;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10788){
var vec__10789 = p__10788;
var ns_detector = cljs.core.nth.call(null,vec__10789,(0),null);
...
var G__10795 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10796 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10795;
remaining_tokens = G__10796;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10786){
var G__10787 = cljs.core.first.call(null,seq10786);
var seq10786__$1 = cljs.core.next.call(null,seq10786);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10787,seq10786__$1);
}));
...
var vec__10800 = cljs.core.split_with.call(null,(function (p1__10799_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10799_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10800,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10800,(1),null);
...
var vec__10806 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10806,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10806,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10809 = cljs.core.rest.call(null,remaining_tokens);
var G__10810 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10809;
name_tokens = G__10810;
continue;
} else {
...
var vec__10813 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10813,(0),null);
var arity = cljs.core.nth.call(null,vec__10813,(1),null);
var vec__10816 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10816,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10816,(1),null);
var vec__10819 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10819,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10819,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10819,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10819,(3),null);
...
var vec__10825 = result;
var munged_ns = cljs.core.nth.call(null,vec__10825,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10825,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10825,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10825,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10825,(4),null);
var arity = cljs.core.nth.call(null,vec__10825,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__10829 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__10829,(0),null);
var args = cljs.core.nth.call(null,vec__10829,(1),null);
var vec__10832 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10832,(0),null);
var name = cljs.core.nth.call(null,vec__10832,(1),null);
...
var G__10835 = (arity + (1));
var G__10836 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10837){
var vec__10838 = p__10837;
var arity = cljs.core.nth.call(null,vec__10838,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10838,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10841_SHARP_){
return cljs.core.get.call(null,arities,p1__10841_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10842_SHARP_){
return cljs.core.drop.call(null,(2),p1__10842_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___10849 = arguments.length;
var i__4865__auto___10850 = (0);
while(true){
if((i__4865__auto___10850 < len__4864__auto___10849)){
args__4870__auto__.push((arguments[i__4865__auto___10850]));

var G__10851 = (i__4865__auto___10850 + (1));
i__4865__auto___10850 = G__10851;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10845){
var vec__10846 = p__10845;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10846,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10843){
var G__10844 = cljs.core.first.call(null,seq10843);
var seq10843__$1 = cljs.core.next.call(null,seq10843);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10844,seq10843__$1);
}));
...
var map__10854 = options;
var map__10854__$1 = cljs.core.__destructure_map.call(null,map__10854);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10854__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10854__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10854__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10854__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10855 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10855,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10855,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10855,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10855,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10855,(4),null);
var arity = cljs.core.nth.call(null,vec__10855,(5),null);
...
var o__10696__auto__ = f;
return (o__10696__auto__["getBasis"]).call(o__10696__auto__);
});
/**
...
}catch (e10858){var _e__10703__auto__ = e10858;
...
var G__10859 = (obj[cljs.core.first.call(null,path)]);
var G__10860 = cljs.core.rest.call(null,path);
obj = G__10859;
path = G__10860;
continue;
} else {
...
var _STAR_ = (function (accum,p__10861){
var vec__10862 = p__10861;
var bit = cljs.core.nth.call(null,vec__10862,(0),null);
var protocol = cljs.core.nth.call(null,vec__10862,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10865){
var vec__10866 = p__10865;
var ns = cljs.core.nth.call(null,vec__10866,(0),null);
var name = cljs.core.nth.call(null,vec__10866,(1),null);
var selector = cljs.core.nth.call(null,vec__10866,(2),null);
...
var post_process = (function (p__10870){
var vec__10871 = p__10870;
var munged_name = cljs.core.nth.call(null,vec__10871,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10871,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10869_SHARP_){
return (obj[cljs.core.first.call(null,p1__10869_SHARP_)]);
}),sorted_matches);
