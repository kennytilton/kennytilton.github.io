...
var map__12539 = top_item;
var map__12539__$1 = cljs.core.__destructure_map.call(null,map__12539);
var file = cljs.core.get.call(null,map__12539__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12539__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12539__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12538){var _e = e12538;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___12540 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___12540)){
var seen_errors_12541 = temp__5718__auto___12540;
if(cljs.core.truth_(seen_errors_12541.has(self))){
} else {
seen_errors_12541.add(self);

var temp__5720__auto___12542 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___12542)){
var sense_12543 = temp__5720__auto___12542;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12543)].join(''));
} else {
}
}
} else {
