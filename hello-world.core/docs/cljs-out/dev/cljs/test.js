...
var G__10342 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10342,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10342;
}
}));
...
var len__4864__auto___10347 = arguments.length;
var i__4865__auto___10348 = (0);
while(true){
if((i__4865__auto___10348 < len__4864__auto___10347)){
args__4870__auto__.push((arguments[i__4865__auto___10348]));

var G__10349 = (i__4865__auto___10348 + (1));
i__4865__auto___10348 = G__10349;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10344){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10345,G__10346,seq10344__$2);
}));
...
var file = cljs.core.get.call(null,map__10351__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10351__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10351__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10350_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10350_SHARP_));
...
var temp__5720__auto___10352 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10352)){
var message_10353 = temp__5720__auto___10352;
cljs.core.println.call(null,message_10353);
} else {
}
...
var temp__5720__auto___10354 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10354)){
var message_10355 = temp__5720__auto___10354;
cljs.core.println.call(null,message_10355);
} else {
}
...
var output_dir__$1 = (function (){var G__10356 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10356,"/"].join('');
} else {
return G__10356;
}
})();
...
var G__10357 = exception.stack;
var G__10357__$1 = (((G__10357 == null))?null:clojure.string.split_lines.call(null,G__10357));
var G__10357__$2 = (((G__10357__$1 == null))?null:cljs.core.get.call(null,G__10357__$1,depth));
if((G__10357__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10357__$2);
}
} else {
...
var vec__10358 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10358,(0),null);
var column = cljs.core.nth.call(null,vec__10358,(1),null);
var vec__10361 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10361,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10361,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10361,(2),null);
...
var m__$1 = (function (){var G__10364 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10368 = (function (){var G__10367 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10367);
} else {
return G__10367;
}
})();
...
return cljs.core.vary_meta.call(null,G__10369,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10370){var e = e10370;
var G__10371 = e;
var G__10371__$1 = (((G__10371 instanceof cljs.core.Keyword))?G__10371.fqn:null);
switch (G__10371__$1) {
...
var vec__10373 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10373,(0),null);
var types = vec__10373;
...
return cljs.core.map.call(null,(function (p__10376){
var vec__10377 = p__10376;
var ns = cljs.core.nth.call(null,vec__10377,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10377,(1),null);
return (function (){
...
var G__10380 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__10381 = cljs.core.seq.call(null,vars__$1);
var chunk__10382 = null;
var count__10383 = (0);
var i__10384 = (0);
while(true){
if((i__10384 < count__10383)){
var v = cljs.core._nth.call(null,chunk__10382,i__10384);
var temp__5720__auto___10386 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10386)){
var t_10387 = temp__5720__auto___10386;
each_fixture_fn.call(null,((function (seq__10381,chunk__10382,count__10383,i__10384,t_10387,temp__5720__auto___10386,v,each_fixture_fn,G__10380,G__10380__$1,env,once_fixtures,each_fixtures,vec__10377,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10387)));
});})(seq__10381,chunk__10382,count__10383,i__10384,t_10387,temp__5720__auto___10386,v,each_fixture_fn,G__10380,G__10380__$1,env,once_fixtures,each_fixtures,vec__10377,ns,vars__$1))
);
} else {
}
...
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__10381__$1);
var G__10392 = cljs.core.chunk_rest.call(null,seq__10381__$1);
var G__10393 = c__4679__auto__;
var G__10394 = cljs.core.count.call(null,c__4679__auto__);
var G__10395 = (0);
seq__10381 = G__10392;
...
var v = cljs.core.first.call(null,seq__10381__$1);
var temp__5720__auto___10396__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10396__$1)){
var t_10397 = temp__5720__auto___10396__$1;
each_fixture_fn.call(null,((function (seq__10381,chunk__10382,count__10383,i__10384,t_10397,temp__5720__auto___10396__$1,v,seq__10381__$1,temp__5720__auto__,each_fixture_fn,G__10380,G__10380__$1,env,once_fixtures,each_fixtures,vec__10377,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10397)));
});})(seq__10381,chunk__10382,count__10383,i__10384,t_10397,temp__5720__auto___10396__$1,v,seq__10381__$1,temp__5720__auto__,each_fixture_fn,G__10380,G__10380__$1,env,once_fixtures,each_fixtures,vec__10377,ns,vars__$1))
);
} else {
}


var G__10398 = cljs.core.next.call(null,seq__10381__$1);
var G__10399 = null;
var G__10400 = (0);
var G__10401 = (0);
seq__10381 = G__10398;
chunk__10382 = G__10399;
count__10383 = G__10400;
i__10384 = G__10401;
continue;
}
} else {
