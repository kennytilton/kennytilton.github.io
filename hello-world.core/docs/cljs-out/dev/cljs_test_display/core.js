...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_10419);
...
var len__4864__auto___10423 = arguments.length;
var i__4865__auto___10424 = (0);
while(true){
if((i__4865__auto___10424 < len__4864__auto___10423)){
args__4870__auto__.push((arguments[i__4865__auto___10424]));

var G__10425 = (i__4865__auto___10424 + (1));
i__4865__auto___10424 = G__10425;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10420){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10421,G__10422,seq10420__$2);
}));
...
var vec__10426 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10426,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10426,(1),null);
var G__10429 = cljs.core.PersistentArrayMap.EMPTY;
var G__10429__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10429,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10429);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10429__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10429__$1;
}
} else {
...
return (function() { 
var G__10433__delegate = function (klass,contents){
var vec__10430 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10430,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10430,(1),null);
...
var G__10433 = function (klass,var_args){
var contents = null;
...
while (G__10434__i < G__10434__a.length) {G__10434__a[G__10434__i] = arguments[G__10434__i + 1]; ++G__10434__i;}
  contents = new cljs.core.IndexedSeq(G__10434__a,0,null);
} 
return G__10433__delegate.call(this,klass,contents);};
G__10433.cljs$lang$maxFixedArity = 1;
G__10433.cljs$lang$applyTo = (function (arglist__10435){
var klass = cljs.core.first(arglist__10435);
var contents = cljs.core.rest(arglist__10435);
return G__10433__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10439){
var map__10440 = p__10439;
var map__10440__$1 = cljs.core.__destructure_map.call(null,map__10440);
var ns = cljs.core.get.call(null,map__10440__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10440__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10441){
var map__10442 = p__10441;
var map__10442__$1 = cljs.core.__destructure_map.call(null,map__10442);
var actual = cljs.core.get.call(null,map__10442__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10442__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10443){
var map__10444 = p__10443;
var map__10444__$1 = cljs.core.__destructure_map.call(null,map__10444);
var expected = cljs.core.get.call(null,map__10444__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10444__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__10445_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__10445_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10447 = cljs_test_display.core.current_var_info.call(null);
var map__10447__$1 = cljs.core.__destructure_map.call(null,map__10447);
var info = map__10447__$1;
var name = cljs.core.get.call(null,map__10447__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10447__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10447__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__10446_SHARP_){
return cljs.core.cons.call(null,node,p1__10446_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10448){
var map__10449 = p__10448;
var map__10449__$1 = cljs.core.__destructure_map.call(null,map__10449);
var m = map__10449__$1;
var fail = cljs.core.get.call(null,map__10449__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10449__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10449__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10449__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___10450 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10450)){
var message_10451 = temp__5720__auto___10450;
cljs.core.println.call(null,message_10451);
} else {
}
...
var temp__5720__auto___10452 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10452)){
var message_10453 = temp__5720__auto___10452;
cljs.core.println.call(null,message_10453);
} else {
}
