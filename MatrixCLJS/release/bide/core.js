...
var m__7310__auto__ = (bide.core._navigate[goog.typeOf(x__7309__auto__)]);
if(!((m__7310__auto__ == null))){
return (m__7310__auto__.cljs$core$IFn$_invoke$arity$4 ? m__7310__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__7310__auto__.call(null,_,loc,params,query));
} else {
var m__7310__auto____$1 = (bide.core._navigate["_"]);
if(!((m__7310__auto____$1 == null))){
return (m__7310__auto____$1.cljs$core$IFn$_invoke$arity$4 ? m__7310__auto____$1.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__7310__auto____$1.call(null,_,loc,params,query));
} else {
...
var x__7309__auto__ = (((_ == null))?null:_);
var m__7310__auto__ = (bide.core._replace[goog.typeOf(x__7309__auto__)]);
if(!((m__7310__auto__ == null))){
return (m__7310__auto__.cljs$core$IFn$_invoke$arity$4 ? m__7310__auto__.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__7310__auto__.call(null,_,loc,params,query));
} else {
var m__7310__auto____$1 = (bide.core._replace["_"]);
if(!((m__7310__auto____$1 == null))){
return (m__7310__auto____$1.cljs$core$IFn$_invoke$arity$4 ? m__7310__auto____$1.cljs$core$IFn$_invoke$arity$4(_,loc,params,query) : m__7310__auto____$1.call(null,_,loc,params,query));
} else {
...
var x__7309__auto__ = (((_ == null))?null:_);
var m__7310__auto__ = (bide.core._repr[goog.typeOf(x__7309__auto__)]);
if(!((m__7310__auto__ == null))){
...
var m__7310__auto____$1 = (bide.core._repr["_"]);
if(!((m__7310__auto____$1 == null))){
...
var vec__15219 = cljs.core.vec(bide.impl.router.match(router,path));
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15219,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15219,(1),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15219,(2),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (router,p__15222){
var vec__15223 = p__15222;
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15223,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15223,(1),null);
return bide.impl.router.insert(router,path,name);
 ...
 */
bide.core.start_BANG_ = (function bide$core$start_BANG_(router,p__15229){
...
var opts = map__15230__$1;
var on_navigate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15230__$1,cljs.core.cst$kw$on_DASH_navigate);
var default$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15230__$1,cljs.core.cst$kw$default);
var html5_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__15230__$1,cljs.core.cst$kw$html5_QMARK_,false);
var html5history = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15230__$1,cljs.core.cst$kw$html5history);
...
var _on_navigate = ((function (default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__on_navigate(event){
var vec__15236 = _match(event.token);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15236,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15236,(1),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15236,(2),null);
...
});})(default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;
var _match = ((function (default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__match(token){
var result = bide.core.match(router,token);
var or__6640__auto__ = result;
...
;
var _initial_token = ((function (default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
var or__6640__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(bide.core.resolve,router,default$__$1);
if(cljs.core.truth_(or__6640__auto__)){
return or__6640__auto__;
} else {
return "/";
...
var history = (cljs.core.truth_(html5_QMARK_)?(function (){var G__15239 = html5history__$1;
G__15239.setPathPrefix("");

G__15239.setUseFragment(false);

G__15239.setEnabled(true);

return G__15239;
})():(function (){var G__15240 = html5history__$1;
G__15240.setUseFragment(true);

G__15240.setEnabled(true);
...
var x15241 = router;
x15241.close = ((function (x15241,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (){
var _ = this;
goog.events.unlistenByKey(lkey);

return history.setEnabled(false);
});})(x15241,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;

x15241.bide$core$IRouter$ = cljs.core.PROTOCOL_SENTINEL;

x15241.bide$core$IRouter$_navigate$arity$4 = ((function (x15241,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
x15241.bide$core$IRouter$_replace$arity$4 = ((function (x15241,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__15230,map__15230__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (_,id,params,query){
var ___$1 = this;
var temp__4657__auto__ = bide.core.resolve.cljs$core$IFn$_invoke$arity$4(router,id,params,query);
if(cljs.core.truth_(temp__4657__auto__)){
