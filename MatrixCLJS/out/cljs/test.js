...
var G__9756 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9756,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9756;
}
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9758){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__9759,G__9760,seq9758__$2);
});
...
var file = cljs.core.get.call(null,map__9765__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9765__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9765__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9765,map__9765__$1,file,line,column){
return (function (p1__9764_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9764_SHARP_));
});})(map__9765,map__9765__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7574__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7574__auto__,prefer_table__7575__auto__,method_cache__7576__auto__,cached_hierarchy__7577__auto__,hierarchy__7578__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6640__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6640__auto__)){
return or__6640__auto__;
} else {
...
var temp__4657__auto___9767 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___9767)){
var message_9768 = temp__4657__auto___9767;
cljs.core.println.call(null,message_9768);
} else {
}
...
var temp__4657__auto___9769 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___9769)){
var message_9770 = temp__4657__auto___9769;
cljs.core.println.call(null,message_9770);
} else {
}
...
var G__9772 = exception.stack;
var G__9772__$1 = (((G__9772 == null))?null:clojure.string.split_lines.call(null,G__9772));
var G__9772__$2 = (((G__9772__$1 == null))?null:cljs.core.get.call(null,G__9772__$1,depth));
if((G__9772__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9772__$2);
}
} else {
...
var vec__9773 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9773,(0),null);
var column = cljs.core.nth.call(null,vec__9773,(1),null);
var vec__9776 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9776,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9776,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9776,(2),null);
...
var m__$1 = (function (){var G__9779 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__9779__$1 = (((G__9779 instanceof cljs.core.Keyword))?G__9779.fqn:null);
switch (G__9779__$1) {
case "fail":
...
var G__9783 = (function (){var G__9782 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9782);
} else {
return G__9782;
}
})();
...
return cljs.core.vary_meta.call(null,G__9784,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9788 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9788,(0),null);
var types = vec__9788;
...
var ns = cljs.core.nth.call(null,vec__9792,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9792,(1),null);
return ((function (vec__9792,ns,vars__$1){
return (function (){
...
var G__9795 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1){
return (function (){
var seq__9796 = cljs.core.seq.call(null,vars__$1);
var chunk__9797 = null;
var count__9798 = (0);
var i__9799 = (0);
while(true){
if((i__9799 < count__9798)){
var v = cljs.core._nth.call(null,chunk__9797,i__9799);
var temp__4657__auto___9801 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___9801)){
var t_9802 = temp__4657__auto___9801;
each_fixture_fn.call(null,((function (seq__9796,chunk__9797,count__9798,i__9799,t_9802,temp__4657__auto___9801,v,each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9802)));
});})(seq__9796,chunk__9797,count__9798,i__9799,t_9802,temp__4657__auto___9801,v,each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1))
);
} else {
}

var G__9803 = seq__9796;
var G__9804 = chunk__9797;
var G__9805 = count__9798;
var G__9806 = (i__9799 + (1));
seq__9796 = G__9803;
chunk__9797 = G__9804;
count__9798 = G__9805;
i__9799 = G__9806;
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__9796);
if(temp__4657__auto__){
var seq__9796__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9796__$1)){
var c__7460__auto__ = cljs.core.chunk_first.call(null,seq__9796__$1);
var G__9807 = cljs.core.chunk_rest.call(null,seq__9796__$1);
var G__9808 = c__7460__auto__;
var G__9809 = cljs.core.count.call(null,c__7460__auto__);
var G__9810 = (0);
seq__9796 = G__9807;
chunk__9797 = G__9808;
count__9798 = G__9809;
...
var v = cljs.core.first.call(null,seq__9796__$1);
var temp__4657__auto___9811__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___9811__$1)){
var t_9812 = temp__4657__auto___9811__$1;
each_fixture_fn.call(null,((function (seq__9796,chunk__9797,count__9798,i__9799,t_9812,temp__4657__auto___9811__$1,v,seq__9796__$1,temp__4657__auto__,each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9812)));
});})(seq__9796,chunk__9797,count__9798,i__9799,t_9812,temp__4657__auto___9811__$1,v,seq__9796__$1,temp__4657__auto__,each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1))
);
} else {
}

var G__9813 = cljs.core.next.call(null,seq__9796__$1);
var G__9814 = null;
var G__9815 = (0);
var G__9816 = (0);
seq__9796 = G__9813;
...
});})(each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1))
);
});})(each_fixture_fn,G__9795,G__9795__$1,env,once_fixtures,each_fixtures,vec__9792,ns,vars__$1))
], null);
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9795__$1)].join('')));

}
})());
});
;})(vec__9792,ns,vars__$1))
