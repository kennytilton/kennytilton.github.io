...
return m__7310__auto__.call(null,_,loc,params,query);
} else {
var m__7310__auto____$1 = (bide.core._navigate["_"]);
if(!((m__7310__auto____$1 == null))){
return m__7310__auto____$1.call(null,_,loc,params,query);
} else {
...
var vec__11283 = cljs.core.vec.call(null,bide.impl.router.match(router,path));
var name = cljs.core.nth.call(null,vec__11283,(0),null);
var params = cljs.core.nth.call(null,vec__11283,(1),null);
var query = cljs.core.nth.call(null,vec__11283,(2),null);
...
return cljs.core.reduce.call(null,(function (router,p__11286){
var vec__11287 = p__11286;
var path = cljs.core.nth.call(null,vec__11287,(0),null);
var name = cljs.core.nth.call(null,vec__11287,(1),null);
return bide.impl.router.insert(router,path,name);
 ...
 */
bide.core.start_BANG_ = (function bide$core$start_BANG_(router,p__11293){
...
var opts = map__11294__$1;
var on_navigate = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908));
var default$ = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"default","default",-1987822328));
var html5_QMARK_ = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"html5?","html5?",-1008298421),false);
var html5history = cljs.core.get.call(null,map__11294__$1,new cljs.core.Keyword(null,"html5history","html5history",-1921478143));
...
var _on_navigate = ((function (default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function bide$core$start_BANG__$__on_navigate(event){
var vec__11299 = _match.call(null,event.token);
var name = cljs.core.nth.call(null,vec__11299,(0),null);
var params = cljs.core.nth.call(null,vec__11299,(1),null);
var query = cljs.core.nth.call(null,vec__11299,(2),null);
return on_navigate.call(null,name,params,query);
});})(default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;
var _match = ((function (default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
;
var _initial_token = ((function (default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
var or__6640__auto__ = cljs.core.apply.call(null,bide.core.resolve,router,default$__$1);
if(cljs.core.truth_(or__6640__auto__)){
return or__6640__auto__;
} else {
return "/";
...
var history = (cljs.core.truth_(html5_QMARK_)?(function (){var G__11302 = html5history__$1;
G__11302.setPathPrefix("");

G__11302.setUseFragment(false);

G__11302.setEnabled(true);

return G__11302;
})():(function (){var G__11303 = html5history__$1;
G__11303.setUseFragment(true);

G__11303.setEnabled(true);
...
var x11304 = router;
x11304.close = ((function (x11304,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (){
var _ = this;
goog.events.unlistenByKey(lkey);

return history.setEnabled(false);
});})(x11304,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history))
;

x11304.bide$core$IRouter$ = cljs.core.PROTOCOL_SENTINEL;

x11304.bide$core$IRouter$_navigate$arity$4 = ((function (x11304,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
...
x11304.bide$core$IRouter$_replace$arity$4 = ((function (x11304,html5history__$1,history,initial_token,initial_loc,lkey,default$__$1,map__11294,map__11294__$1,opts,on_navigate,default$,html5_QMARK_,html5history){
return (function (_,id,params,query){
var ___$1 = this;
var temp__4657__auto__ = bide.core.resolve.call(null,router,id,params,query);
if(cljs.core.truth_(temp__4657__auto__)){
